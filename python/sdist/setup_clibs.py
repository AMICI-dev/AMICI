...
def get_suite_sparse_sources(ss_base_dir: Path) -> List[str]:
    ...
    """
    return list(map(str, [
        ss_base_dir / 'KLU' / 'Source' / 'klu_l_analyze_given.c',
        ss_base_dir / 'KLU' / 'Source' / 'klu_l_analyze.c',
        ss_base_dir / 'KLU' / 'Source' / 'klu_l_defaults.c',
        ss_base_dir / 'KLU' / 'Source' / 'klu_l_diagnostics.c',
        ss_base_dir / 'KLU' / 'Source' / 'klu_l_dump.c',
        ss_base_dir / 'KLU' / 'Source' / 'klu_l_extract.c',
        ss_base_dir / 'KLU' / 'Source' / 'klu_l_factor.c',
        ss_base_dir / 'KLU' / 'Source' / 'klu_l_free_numeric.c',
        ss_base_dir / 'KLU' / 'Source' / 'klu_l_free_symbolic.c',
        ss_base_dir / 'KLU' / 'Source' / 'klu_l_kernel.c',
        ss_base_dir / 'KLU' / 'Source' / 'klu_l_memory.c',
        ss_base_dir / 'KLU' / 'Source' / 'klu_l_refactor.c',
        ss_base_dir / 'KLU' / 'Source' / 'klu_l_scale.c',
        ss_base_dir / 'KLU' / 'Source' / 'klu_l_sort.c',
        ss_base_dir / 'KLU' / 'Source' / 'klu_l_solve.c',
        ss_base_dir / 'KLU' / 'Source' / 'klu_l_tsolve.c',
        ss_base_dir / 'KLU' / 'Source' / 'klu_l.c',
        ss_base_dir / 'AMD' / 'Source' / 'amd_l1.c',
        ss_base_dir / 'AMD' / 'Source' / 'amd_l2.c',
        ss_base_dir / 'AMD' / 'Source' / 'amd_l_aat.c',
        ss_base_dir / 'AMD' / 'Source' / 'amd_l_control.c',
        ss_base_dir / 'AMD' / 'Source' / 'amd_l_defaults.c',
        ss_base_dir / 'AMD' / 'Source' / 'amd_l_dump.c',
        ss_base_dir / 'AMD' / 'Source' / 'amd_l_info.c',
        ss_base_dir / 'AMD' / 'Source' / 'amd_l_order.c',
        ss_base_dir / 'AMD' / 'Source' / 'amd_l_post_tree.c',
        ss_base_dir / 'AMD' / 'Source' / 'amd_l_postorder.c',
        ss_base_dir / 'AMD' / 'Source' / 'amd_l_preprocess.c',
        ss_base_dir / 'AMD' / 'Source' / 'amd_l_valid.c',
        ss_base_dir / 'COLAMD' / 'Source' / 'colamd_l.c',
        ss_base_dir / 'BTF' / 'Source' / 'btf_l_maxtrans.c',
        ss_base_dir / 'BTF' / 'Source' / 'btf_l_order.c',
        ss_base_dir / 'BTF' / 'Source' / 'btf_l_strongcomp.c',
