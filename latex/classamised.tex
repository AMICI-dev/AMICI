...
\begin{DoxyCompactList}\small\item\em amised reads in an SEDML document using the JAVA binding of of lib\+SEDML \end{DoxyCompactList}\end{DoxyCompactItemize}
...
{\em sedname} & name/path of the SEDML document \\
\hline
\end{DoxyParams}
