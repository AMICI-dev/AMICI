...
\begin{center}
\leavevmode
\includegraphics[width=164pt]{classamioption__inherit__graph}
\end{center}
\end{figure}
...
\begin{DoxyCompactList}\small\item\em amioptions Construct a new amioptions object OPTS = \mbox{\hyperlink{classamioption_a86c655c4010c1c2ddb3e68693a07ef37}{amioption()}} creates a set of options with each option set to its default value. \end{DoxyCompactList}\end{DoxyCompactItemize}
\doxysubsubsection*{Static Public Member Functions}
\begin{DoxyCompactItemize}
\item 
static mlhs\+Inner\+Subst$<$ matlabtypesubstitute $>$ \mbox{\hyperlink{classamioption_ab36a59e8722964858e702a11b4fce78f}{get\+Integer\+PScale}} (matlabtypesubstitute pscale\+String)
\begin{DoxyCompactList}\small\item\em pscale\+Int converts a parameter scaling string into the corresponding integer representation \end{DoxyCompactList}\end{DoxyCompactItemize}
...
OPTS = \mbox{\hyperlink{classamioption}{amioption(\+PARAM, VAL, ...)}} creates a set of options with the named parameters altered with the specified values.

OPTS = \mbox{\hyperlink{classamioption}{amioption(\+OLDOPTS, PARAM, VAL, ...)}} creates a copy of OLDOPTS with the named parameters altered with the specified value
...
\mbox{\Hypertarget{classamioption_ab36a59e8722964858e702a11b4fce78f}\label{classamioption_ab36a59e8722964858e702a11b4fce78f}} 
\index{amioption@{amioption}!getIntegerPScale@{getIntegerPScale}}
\index{getIntegerPScale@{getIntegerPScale}!amioption@{amioption}}
\doxyparagraph{\texorpdfstring{getIntegerPScale()}{getIntegerPScale()}}
{\footnotesize\ttfamily mlhs\+Inner\+Subst$<$ matlabtypesubstitute $>$ get\+Integer\+PScale (\begin{DoxyParamCaption}\item[{matlabtypesubstitute}]{pscale\+String }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [static]}}


\begin{DoxyParams}{Parameters}
{\em pscale\+String} & parameter scaling string\\
\hline
\end{DoxyParams}

\begin{DoxyRetVals}{Return values}
{\em pscale\+String} & int \\
\hline
\end{DoxyRetVals}


Definition at line 494 of file amioption.\+m.
