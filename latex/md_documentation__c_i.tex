...
The CI scripts and tests can be found in {\ttfamily tests/} and {\ttfamily scripts/}. Some of the tests are integrated with C\+Make, see {\ttfamily make help} in the build directory.\hypertarget{md_documentation__c_i_autotoc_md98}{}\doxysubsection{C++ unit and integration tests}\label{md_documentation__c_i_autotoc_md98}
To run C++ tests, build A\+M\+I\+CI with {\ttfamily make} or {\ttfamily scripts/build\+All.\+sh}, then run {\ttfamily scripts/run-\/cpputest.\+sh}.\hypertarget{md_documentation__c_i_autotoc_md99}{}\doxysubsection{Python unit and integration tests}\label{md_documentation__c_i_autotoc_md99}
To run Python tests, run {\ttfamily ../scripts/run-\/python-\/tests.sh} from anywhere (assumes build directory is {\ttfamily build/}) or run {\ttfamily make python-\/tests} in your build directory.\hypertarget{md_documentation__c_i_autotoc_md100}{}\doxysubsubsection{S\+B\+M\+L Test Suite}\label{md_documentation__c_i_autotoc_md100}
...
\end{DoxyEnumerate}\hypertarget{md_documentation__c_i_autotoc_md101}{}\doxysubsection{Matlab tests (not included in C\+I pipeline)}\label{md_documentation__c_i_autotoc_md101}
To execute the Matlab test suite, run {\ttfamily tests/test\+Models.\+m}.\hypertarget{md_documentation__c_i_autotoc_md102}{}\doxysubsection{Model simulation integration tests}\label{md_documentation__c_i_autotoc_md102}
...
\end{DoxyVerb}
\hypertarget{md_documentation__c_i_autotoc_md105}{}\doxysubsection{Adding/\+Updating tests}\label{md_documentation__c_i_autotoc_md105}
