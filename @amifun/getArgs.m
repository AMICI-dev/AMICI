function this = getArgs(this,model)
    ...
    switch(this.funstr)
        ...
        case 'Jz'
            this.argstr = '(realtype t, int ie, realtype *Jz, realtype *z, realtype *mz, realtype *sigma_z, void *user_data)';
        case 'dJzdx'
            this.argstr = '(realtype t, int ie, realtype *dJzdx, realtype *z, realtype *dzdx, realtype *mz, realtype *sigma_z, void *user_data)';
        case 'dJzdp'
            this.argstr = '(realtype t, int ie, realtype *dJzdp, realtype *z, realtype *dzdp, realtype *mz, realtype *sigma_z, realtype *dsigma_zdp, void *user_data)';
        case 'sJz'
            this.argstr = '(realtype t, int ie, realtype *sJz, realtype *z, realtype *dzdp, realtype *sz, realtype *mz, realtype *sigma_z, realtype *dsigma_zdp, void *user_data)';
        otherwise
            % do nothing
    end
