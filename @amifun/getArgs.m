function this = getArgs(this,model)
    ...
    switch(this.funstr)
        ...
        case 'sJy'
            this.argstr = '(realtype t, int it, realtype *sJy, realtype *y, N_Vector x, realtype *dydp, realtype *sy, realtype *my, realtype *sd_y, realtype *dsigma_ydp, void *user_data)';
        case 'Jz'
        ...
        case 'w'
            this.argstr = ['(realtype t, realtype *w, N_Vector x,' dxvec ' void *user_data)'];
        case 'dwdp'
            this.argstr = ['(realtype t, realtype *dwdp, N_Vector x,' dxvec ' void *user_data)'];
        case 'dwdx'
            this.argstr = ['(realtype t, realtype *dwdx, N_Vector x,' dxvec ' void *user_data)'];
        otherwise
            %nothing
    end
