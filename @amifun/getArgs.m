function this = getArgs(this,model)
    ...
    switch(this.funstr)
        ...
        case 'sJy'
            this.argstr = '(realtype t, int it, realtype *sJy, realtype *s2Jy, realtype *dJydy, realtype *dJydp, realtype *y, realtype *sigma_y, realtype *sy, realtype *dydp, realtype *my, void *user_data)';
        case 'Jz'
