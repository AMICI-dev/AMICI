function printLocalVars(this,model,fid)
    ...
    switch(this.funstr)
        ...
        case 'qBdot'
            fprintf(fid,'memset(qBdot_tmp,0,sizeof(realtype)*udata->nplist*udata->nJ);\n');
        case 'x0'
        ...
        case 'dJydp'
            fprintf(fid,['memset(tdata->dJydp,0,sizeof(realtype)*udata->nytrue*udata->nplist*udata->nJ);\n']);
        case 'Jz'
            % nothing
        case 'dJzdx'
            % nothing
