...
def get_extension() -> CMakeExtension:
    ...
    return CMakeExtension(
        ...
        install_prefix="model_jakstat_adjoint_py",
...
# Install
setup(
    name="model_jakstat_adjoint_py",
    cmdclass=CMDCLASS,
    version="0.1.0",
    description="AMICI-generated module for model model_jakstat_adjoint_py",
    url="https://github.com/AMICI-dev/AMICI",
    author="model-author-todo",
    author_email="model-author-todo",
    ext_modules=[MODEL_EXT],
    packages=find_namespace_packages(),
    install_requires=["amici==1.1.0"],
