...
extern const std::array<std::string_view const, 3> free_parameter_names;
extern const std::array<std::string_view const, 1> fixed_parameter_names;
...
extern const std::array<std::string_view const, 3> free_parameter_ids;
extern const std::array<std::string_view const, 1> fixed_parameter_ids;
...
extern void dJydsigmay_model_robertson_py(realtype *dJydsigmay, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my);
extern void dJydy_model_robertson_py(realtype *dJydy, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my);
extern void dJydy_colptrs_model_robertson_py(SUNMatrixWrapper &colptrs, int index);
extern void dJydy_rowvals_model_robertson_py(SUNMatrixWrapper &rowvals, int index);
...
extern void dxdotdp_explicit_model_robertson_py(realtype *dxdotdp_explicit, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *dx, const realtype *w);
extern void dxdotdp_explicit_colptrs_model_robertson_py(SUNMatrixWrapper &colptrs);
extern void dxdotdp_explicit_rowvals_model_robertson_py(SUNMatrixWrapper &rowvals);
...
extern void sigmay_model_robertson_py(realtype *sigmay, const realtype t, const realtype *p, const realtype *k, const realtype *y);





extern void x0_model_robertson_py(realtype *x0, const realtype t, const realtype *p, const realtype *k);
extern void x0_fixedParameters_model_robertson_py(realtype *x0_fixedParameters, const realtype t, const realtype *p, const realtype *k, gsl::span<const int> reinitialization_state_idxs);

extern void sx0_fixedParameters_model_robertson_py(realtype *sx0_fixedParameters, const realtype t, const realtype *x0, const realtype *p, const realtype *k, const int ip, gsl::span<const int> reinitialization_state_idxs);
extern void xdot_model_robertson_py(realtype *xdot, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *dx, const realtype *w);
extern void y_model_robertson_py(realtype *y, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w);
...
extern void x_solver_model_robertson_py(realtype *x_solver, const realtype *x_rdata);
...
extern std::vector<HermiteSpline> create_splines_model_robertson_py(const realtype *p, const realtype *k);
 ...
 */
class Model_model_robertson_py : public amici::Model_DAE {
  public:
    /**
     * @brief Default constructor.
     */
    Model_model_robertson_py()
        : amici::Model_DAE(
    ...
    amici::Model *clone() const override {
        return new Model_model_robertson_py(*this);
    }
    ...
    void fJy(realtype *Jy, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my) override {
        Jy_model_robertson_py(Jy, iy, p, k, y, sigmay, my);
    }
    ...
    void fdJydsigmay(realtype *dJydsigmay, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my) override {
        dJydsigmay_model_robertson_py(dJydsigmay, iy, p, k, y, sigmay, my);
    }
    ...
    void fdxdotdp_explicit(realtype *dxdotdp_explicit, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *dx, const realtype *w) override {
        dxdotdp_explicit_model_robertson_py(dxdotdp_explicit, t, x, p, k, h, dx, w);
    }

    void fdxdotdp_explicit_colptrs(SUNMatrixWrapper &colptrs) override {
        dxdotdp_explicit_colptrs_model_robertson_py(colptrs);
    }

    void fdxdotdp_explicit_rowvals(SUNMatrixWrapper &rowvals) override {
        dxdotdp_explicit_rowvals_model_robertson_py(rowvals);
    }
    ...
    void fdxdotdx_explicit(realtype *dxdotdx_explicit, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *dx, const realtype *w) override {
        dxdotdx_explicit_model_robertson_py(dxdotdx_explicit, t, x, p, k, h, dx, w);
    }

    void fdxdotdx_explicit_colptrs(SUNMatrixWrapper &colptrs) override {
        dxdotdx_explicit_colptrs_model_robertson_py(colptrs);
    }

    void fdxdotdx_explicit_rowvals(SUNMatrixWrapper &rowvals) override {
        dxdotdx_explicit_rowvals_model_robertson_py(rowvals);
    }
    ...
    void fsigmay(realtype *sigmay, const realtype t, const realtype *p, const realtype *k, const realtype *y) override {
        sigmay_model_robertson_py(sigmay, t, p, k, y);
    }
    ...
    void fsx0_fixedParameters(realtype *sx0_fixedParameters, const realtype t, const realtype *x0, const realtype *p, const realtype *k, const int ip, gsl::span<const int> reinitialization_state_idxs) override {
        sx0_fixedParameters_model_robertson_py(sx0_fixedParameters, t, x0, p, k, ip,  reinitialization_state_idxs);
    }
    ...
    void fx0(realtype *x0, const realtype t, const realtype *p, const realtype *k) override {
        x0_model_robertson_py(x0, t, p, k);
    }
    ...
    void fx0_fixedParameters(realtype *x0_fixedParameters, const realtype t, const realtype *p, const realtype *k, gsl::span<const int> reinitialization_state_idxs) override {
        x0_fixedParameters_model_robertson_py(x0_fixedParameters, t, p, k,  reinitialization_state_idxs);
    }
    ...
    void fxdot(realtype *xdot, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *dx, const realtype *w) override {
        xdot_model_robertson_py(xdot, t, x, p, k, h, dx, w);
    }
    ...
    void fy(realtype *y, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w) override {
        y_model_robertson_py(y, t, x, p, k, h, w);
    }
    ...
    void fx_solver(realtype *x_solver, const realtype *x_rdata) override {
        x_solver_model_robertson_py(x_solver, x_rdata);
    }
