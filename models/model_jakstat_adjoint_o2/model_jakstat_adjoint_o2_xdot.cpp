...
status = w_model_jakstat_adjoint_o2(t,x,NULL,user_data);
  ...
  xdot_tmp[54] = -udata->p[0]*udata->w[5]*x_tmp[0]-udata->p[0]*udata->w[0]*x_tmp[54]+udata->k[1]*udata->p[3]*udata->w[2]*x_tmp[62];
  xdot_tmp[55] = udata->p[0]*udata->w[5]*x_tmp[0]+udata->p[0]*udata->w[0]*x_tmp[54]-udata->p[1]*x_tmp[1]*x_tmp[55]*4.0;
  ...
  xdot_tmp[63] = -udata->p[0]*udata->w[6]*x_tmp[0]-udata->p[0]*udata->w[0]*x_tmp[63]+udata->k[1]*udata->p[3]*udata->w[2]*x_tmp[71];
  xdot_tmp[64] = udata->p[0]*udata->w[6]*x_tmp[0]+udata->p[0]*udata->w[0]*x_tmp[63]-udata->p[1]*x_tmp[1]*x_tmp[64]*4.0;
  ...
  xdot_tmp[72] = -udata->p[0]*udata->w[7]*x_tmp[0]-udata->p[0]*udata->w[0]*x_tmp[72]+udata->k[1]*udata->p[3]*udata->w[2]*x_tmp[80];
  xdot_tmp[73] = udata->p[0]*udata->w[7]*x_tmp[0]+udata->p[0]*udata->w[0]*x_tmp[72]-udata->p[1]*x_tmp[1]*x_tmp[73]*4.0;
  ...
  xdot_tmp[81] = -udata->p[0]*udata->w[8]*x_tmp[0]-udata->p[0]*udata->w[0]*x_tmp[81]+udata->k[1]*udata->p[3]*udata->w[2]*x_tmp[89];
  xdot_tmp[82] = udata->p[0]*udata->w[8]*x_tmp[0]+udata->p[0]*udata->w[0]*x_tmp[81]-udata->p[1]*x_tmp[1]*x_tmp[82]*4.0;
  ...
  xdot_tmp[90] = -udata->p[0]*udata->w[9]*x_tmp[0]-udata->p[0]*udata->w[0]*x_tmp[90]+udata->k[1]*udata->p[3]*udata->w[2]*x_tmp[98];
  xdot_tmp[91] = udata->p[0]*udata->w[9]*x_tmp[0]+udata->p[0]*udata->w[0]*x_tmp[90]-udata->p[1]*x_tmp[1]*x_tmp[91]*4.0;
