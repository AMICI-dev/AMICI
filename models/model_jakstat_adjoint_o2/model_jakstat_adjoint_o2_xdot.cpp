...
status = w_model_jakstat_adjoint_o2(t,x,NULL,user_data);
  xdot_tmp[0] = udata->w[2]*(udata->k[1]*udata->p[3]*x_tmp[8]-udata->k[0]*udata->p[0]*udata->w[0]*x_tmp[0]);
  xdot_tmp[1] = udata->p[1]*udata->w[1]*-2.0+udata->p[0]*udata->w[0]*x_tmp[0];
  xdot_tmp[2] = udata->p[1]*udata->w[1]-udata->p[2]*x_tmp[2];
  xdot_tmp[3] = udata->w[3]*(udata->k[0]*udata->p[2]*x_tmp[2]-udata->k[1]*udata->p[3]*x_tmp[3]);
  xdot_tmp[4] = udata->p[3]*(udata->w[4]-x_tmp[4]);
  ...
  xdot_tmp[9] = -udata->w[0]*x_tmp[0]-udata->p[0]*udata->w[0]*x_tmp[9]+udata->k[1]*udata->p[3]*udata->w[2]*x_tmp[17];
  xdot_tmp[10] = udata->w[0]*x_tmp[0]+udata->p[0]*udata->w[0]*x_tmp[9]-udata->p[1]*x_tmp[1]*x_tmp[10]*4.0;
  xdot_tmp[11] = -udata->p[2]*x_tmp[11]+udata->p[1]*x_tmp[1]*x_tmp[10]*2.0;
  xdot_tmp[12] = -udata->p[3]*x_tmp[12]+udata->k[0]*udata->p[2]*udata->w[3]*x_tmp[11];
  ...
  xdot_tmp[18] = -udata->p[0]*udata->w[0]*x_tmp[18]+udata->k[1]*udata->p[3]*udata->w[2]*x_tmp[26];
  xdot_tmp[19] = udata->w[1]*-2.0+udata->p[0]*udata->w[0]*x_tmp[18]-udata->p[1]*x_tmp[1]*x_tmp[19]*4.0;
  xdot_tmp[20] = udata->w[1]-udata->p[2]*x_tmp[20]+udata->p[1]*x_tmp[1]*x_tmp[19]*2.0;
  xdot_tmp[21] = -udata->p[3]*x_tmp[21]+udata->k[0]*udata->p[2]*udata->w[3]*x_tmp[20];
  ...
  xdot_tmp[27] = -udata->p[0]*udata->w[0]*x_tmp[27]+udata->k[1]*udata->p[3]*udata->w[2]*x_tmp[35];
  xdot_tmp[28] = udata->p[0]*udata->w[0]*x_tmp[27]-udata->p[1]*x_tmp[1]*x_tmp[28]*4.0;
  xdot_tmp[29] = -x_tmp[2]-udata->p[2]*x_tmp[29]+udata->p[1]*x_tmp[1]*x_tmp[28]*2.0;
  xdot_tmp[30] = -udata->p[3]*x_tmp[30]+udata->k[0]*udata->w[3]*x_tmp[2]+udata->k[0]*udata->p[2]*udata->w[3]*x_tmp[29];
  ...
  xdot_tmp[36] = udata->k[1]*udata->w[2]*x_tmp[8]-udata->p[0]*udata->w[0]*x_tmp[36]+udata->k[1]*udata->p[3]*udata->w[2]*x_tmp[44];
  xdot_tmp[37] = udata->p[0]*udata->w[0]*x_tmp[36]-udata->p[1]*x_tmp[1]*x_tmp[37]*4.0;
  xdot_tmp[38] = -udata->p[2]*x_tmp[38]+udata->p[1]*x_tmp[1]*x_tmp[37]*2.0;
  xdot_tmp[39] = -x_tmp[3]-udata->p[3]*x_tmp[39]+udata->k[0]*udata->p[2]*udata->w[3]*x_tmp[38];
  xdot_tmp[40] = udata->w[4]-x_tmp[4]+udata->p[3]*x_tmp[39]*2.0-udata->p[3]*x_tmp[40];
  ...
  xdot_tmp[45] = -udata->p[0]*udata->w[0]*x_tmp[45]+udata->k[1]*udata->p[3]*udata->w[2]*x_tmp[53];
  xdot_tmp[46] = udata->p[0]*udata->w[0]*x_tmp[45]-udata->p[1]*x_tmp[1]*x_tmp[46]*4.0;
  xdot_tmp[47] = -udata->p[2]*x_tmp[47]+udata->p[1]*x_tmp[1]*x_tmp[46]*2.0;
  xdot_tmp[48] = -udata->p[3]*x_tmp[48]+udata->k[0]*udata->p[2]*udata->w[3]*x_tmp[47];
  ...
  xdot_tmp[54] = -udata->p[0]*x_tmp[0]*udata->w[5]-udata->p[0]*udata->w[0]*x_tmp[54]+udata->k[1]*udata->p[3]*udata->w[2]*x_tmp[62];
  xdot_tmp[55] = udata->p[0]*x_tmp[0]*udata->w[5]+udata->p[0]*udata->w[0]*x_tmp[54]-udata->p[1]*x_tmp[1]*x_tmp[55]*4.0;
  xdot_tmp[56] = -udata->p[2]*x_tmp[56]+udata->p[1]*x_tmp[1]*x_tmp[55]*2.0;
  xdot_tmp[57] = -udata->p[3]*x_tmp[57]+udata->k[0]*udata->p[2]*udata->w[3]*x_tmp[56];
  ...
  xdot_tmp[63] = -udata->p[0]*x_tmp[0]*udata->w[6]-udata->p[0]*udata->w[0]*x_tmp[63]+udata->k[1]*udata->p[3]*udata->w[2]*x_tmp[71];
  xdot_tmp[64] = udata->p[0]*x_tmp[0]*udata->w[6]+udata->p[0]*udata->w[0]*x_tmp[63]-udata->p[1]*x_tmp[1]*x_tmp[64]*4.0;
  xdot_tmp[65] = -udata->p[2]*x_tmp[65]+udata->p[1]*x_tmp[1]*x_tmp[64]*2.0;
  xdot_tmp[66] = -udata->p[3]*x_tmp[66]+udata->k[0]*udata->p[2]*udata->w[3]*x_tmp[65];
  ...
  xdot_tmp[72] = -udata->p[0]*x_tmp[0]*udata->w[7]-udata->p[0]*udata->w[0]*x_tmp[72]+udata->k[1]*udata->p[3]*udata->w[2]*x_tmp[80];
  xdot_tmp[73] = udata->p[0]*x_tmp[0]*udata->w[7]+udata->p[0]*udata->w[0]*x_tmp[72]-udata->p[1]*x_tmp[1]*x_tmp[73]*4.0;
  xdot_tmp[74] = -udata->p[2]*x_tmp[74]+udata->p[1]*x_tmp[1]*x_tmp[73]*2.0;
  xdot_tmp[75] = -udata->p[3]*x_tmp[75]+udata->k[0]*udata->p[2]*udata->w[3]*x_tmp[74];
  ...
  xdot_tmp[81] = -udata->p[0]*x_tmp[0]*udata->w[8]-udata->p[0]*udata->w[0]*x_tmp[81]+udata->k[1]*udata->p[3]*udata->w[2]*x_tmp[89];
  xdot_tmp[82] = udata->p[0]*x_tmp[0]*udata->w[8]+udata->p[0]*udata->w[0]*x_tmp[81]-udata->p[1]*x_tmp[1]*x_tmp[82]*4.0;
  xdot_tmp[83] = -udata->p[2]*x_tmp[83]+udata->p[1]*x_tmp[1]*x_tmp[82]*2.0;
  xdot_tmp[84] = -udata->p[3]*x_tmp[84]+udata->k[0]*udata->p[2]*udata->w[3]*x_tmp[83];
  ...
  xdot_tmp[90] = -udata->p[0]*x_tmp[0]*udata->w[9]-udata->p[0]*udata->w[0]*x_tmp[90]+udata->k[1]*udata->p[3]*udata->w[2]*x_tmp[98];
  xdot_tmp[91] = udata->p[0]*x_tmp[0]*udata->w[9]+udata->p[0]*udata->w[0]*x_tmp[90]-udata->p[1]*x_tmp[1]*x_tmp[91]*4.0;
  xdot_tmp[92] = -udata->p[2]*x_tmp[92]+udata->p[1]*x_tmp[1]*x_tmp[91]*2.0;
  xdot_tmp[93] = -udata->p[3]*x_tmp[93]+udata->k[0]*udata->p[2]*udata->w[3]*x_tmp[92];
  ...
  xdot_tmp[99] = -udata->p[0]*udata->w[0]*x_tmp[99]+udata->k[1]*udata->p[3]*udata->w[2]*x_tmp[107];
  xdot_tmp[100] = udata->p[0]*udata->w[0]*x_tmp[99]-udata->p[1]*x_tmp[1]*x_tmp[100]*4.0;
  xdot_tmp[101] = -udata->p[2]*x_tmp[101]+udata->p[1]*x_tmp[1]*x_tmp[100]*2.0;
  xdot_tmp[102] = -udata->p[3]*x_tmp[102]+udata->k[0]*udata->p[2]*udata->w[3]*x_tmp[101];
  ...
  xdot_tmp[108] = -udata->p[0]*udata->w[0]*x_tmp[108]+udata->k[1]*udata->p[3]*udata->w[2]*x_tmp[116];
  xdot_tmp[109] = udata->p[0]*udata->w[0]*x_tmp[108]-udata->p[1]*x_tmp[1]*x_tmp[109]*4.0;
  xdot_tmp[110] = -udata->p[2]*x_tmp[110]+udata->p[1]*x_tmp[1]*x_tmp[109]*2.0;
  xdot_tmp[111] = -udata->p[3]*x_tmp[111]+udata->k[0]*udata->p[2]*udata->w[3]*x_tmp[110];
  ...
  xdot_tmp[117] = -udata->p[0]*udata->w[0]*x_tmp[117]+udata->k[1]*udata->p[3]*udata->w[2]*x_tmp[125];
  xdot_tmp[118] = udata->p[0]*udata->w[0]*x_tmp[117]-udata->p[1]*x_tmp[1]*x_tmp[118]*4.0;
  xdot_tmp[119] = -udata->p[2]*x_tmp[119]+udata->p[1]*x_tmp[1]*x_tmp[118]*2.0;
  xdot_tmp[120] = -udata->p[3]*x_tmp[120]+udata->k[0]*udata->p[2]*udata->w[3]*x_tmp[119];
  ...
  xdot_tmp[126] = -udata->p[0]*udata->w[0]*x_tmp[126]+udata->k[1]*udata->p[3]*udata->w[2]*x_tmp[134];
  xdot_tmp[127] = udata->p[0]*udata->w[0]*x_tmp[126]-udata->p[1]*x_tmp[1]*x_tmp[127]*4.0;
  xdot_tmp[128] = -udata->p[2]*x_tmp[128]+udata->p[1]*x_tmp[1]*x_tmp[127]*2.0;
  xdot_tmp[129] = -udata->p[3]*x_tmp[129]+udata->k[0]*udata->p[2]*udata->w[3]*x_tmp[128];
  ...
  xdot_tmp[135] = -udata->p[0]*udata->w[0]*x_tmp[135]+udata->k[1]*udata->p[3]*udata->w[2]*x_tmp[143];
  xdot_tmp[136] = udata->p[0]*udata->w[0]*x_tmp[135]-udata->p[1]*x_tmp[1]*x_tmp[136]*4.0;
  xdot_tmp[137] = -udata->p[2]*x_tmp[137]+udata->p[1]*x_tmp[1]*x_tmp[136]*2.0;
  xdot_tmp[138] = -udata->p[3]*x_tmp[138]+udata->k[0]*udata->p[2]*udata->w[3]*x_tmp[137];
  ...
  xdot_tmp[144] = -udata->p[0]*udata->w[0]*x_tmp[144]+udata->k[1]*udata->p[3]*udata->w[2]*x_tmp[152];
  xdot_tmp[145] = udata->p[0]*udata->w[0]*x_tmp[144]-udata->p[1]*x_tmp[1]*x_tmp[145]*4.0;
  xdot_tmp[146] = -udata->p[2]*x_tmp[146]+udata->p[1]*x_tmp[1]*x_tmp[145]*2.0;
  xdot_tmp[147] = -udata->p[3]*x_tmp[147]+udata->k[0]*udata->p[2]*udata->w[3]*x_tmp[146];
  ...
  xdot_tmp[153] = -udata->p[0]*udata->w[0]*x_tmp[153]+udata->k[1]*udata->p[3]*udata->w[2]*x_tmp[161];
  xdot_tmp[154] = udata->p[0]*udata->w[0]*x_tmp[153]-udata->p[1]*x_tmp[1]*x_tmp[154]*4.0;
  xdot_tmp[155] = -udata->p[2]*x_tmp[155]+udata->p[1]*x_tmp[1]*x_tmp[154]*2.0;
  xdot_tmp[156] = -udata->p[3]*x_tmp[156]+udata->k[0]*udata->p[2]*udata->w[3]*x_tmp[155];
