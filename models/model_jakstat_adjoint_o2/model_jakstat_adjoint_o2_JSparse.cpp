...
status = dwdx_model_jakstat_adjoint_o2(t,x,NULL,user_data);
  J->data[0] = -udata->k[0]*udata->p[0]*tdata->w[0]*tdata->w[2];
  J->data[1] = udata->p[0]*tdata->w[0];
  J->data[2] = -tdata->w[0];
  J->data[3] = tdata->w[0];
  J->data[4] = -udata->p[0]*tdata->w[5];
  J->data[5] = udata->p[0]*tdata->w[5];
  J->data[6] = -udata->p[0]*tdata->w[6];
  J->data[7] = udata->p[0]*tdata->w[6];
  J->data[8] = -udata->p[0]*tdata->w[7];
  J->data[9] = udata->p[0]*tdata->w[7];
  J->data[10] = -udata->p[0]*tdata->w[8];
  J->data[11] = udata->p[0]*tdata->w[8];
  J->data[12] = -udata->p[0]*tdata->w[9];
  J->data[13] = udata->p[0]*tdata->w[9];
  J->data[14] = udata->p[1]*tdata->dwdx[0]*-2.0;
  J->data[15] = udata->p[1]*tdata->dwdx[0];
  J->data[16] = udata->p[1]*x_tmp[10]*-4.0;
  J->data[17] = udata->p[1]*x_tmp[10]*2.0;
  J->data[18] = tdata->dwdx[0]*-2.0-udata->p[1]*x_tmp[19]*4.0;
  J->data[19] = tdata->dwdx[0]+udata->p[1]*x_tmp[19]*2.0;
  ...
  J->data[50] = -udata->p[2];
  J->data[51] = udata->k[0]*udata->p[2]*tdata->w[3];
  J->data[52] = -1.0;
  J->data[53] = udata->k[0]*tdata->w[3];
  J->data[54] = -udata->k[1]*udata->p[3]*tdata->w[3];
  J->data[55] = udata->p[3]*tdata->dwdx[1];
  J->data[56] = -1.0;
  ...
  J->data[72] = -1.0;
  J->data[73] = 1.0;
  J->data[74] = udata->k[1]*udata->p[3]*tdata->w[2];
  J->data[75] = -udata->p[3];
  J->data[76] = udata->k[1]*tdata->w[2];
  J->data[77] = -1.0;
  J->data[78] = -udata->p[0]*tdata->w[0];
  J->data[79] = udata->p[0]*tdata->w[0];
  J->data[80] = udata->p[1]*x_tmp[1]*-4.0;
  J->data[81] = udata->p[1]*x_tmp[1]*2.0;
  J->data[82] = -udata->p[2];
  J->data[83] = udata->k[0]*udata->p[2]*tdata->w[3];
  J->data[84] = -udata->p[3];
  ...
  J->data[92] = -udata->p[3];
  J->data[93] = udata->p[3];
  J->data[94] = udata->k[1]*udata->p[3]*tdata->w[2];
  J->data[95] = -udata->p[3];
  J->data[96] = -udata->p[0]*tdata->w[0];
  J->data[97] = udata->p[0]*tdata->w[0];
  J->data[98] = udata->p[1]*x_tmp[1]*-4.0;
  J->data[99] = udata->p[1]*x_tmp[1]*2.0;
  J->data[100] = -udata->p[2];
  J->data[101] = udata->k[0]*udata->p[2]*tdata->w[3];
  ...
  J->data[112] = udata->k[1]*udata->p[3]*tdata->w[2];
  J->data[113] = -udata->p[3];
  J->data[114] = -udata->p[0]*tdata->w[0];
  J->data[115] = udata->p[0]*tdata->w[0];
  J->data[116] = udata->p[1]*x_tmp[1]*-4.0;
  J->data[117] = udata->p[1]*x_tmp[1]*2.0;
  J->data[118] = -udata->p[2];
  J->data[119] = udata->k[0]*udata->p[2]*tdata->w[3];
  ...
  J->data[130] = udata->k[1]*udata->p[3]*tdata->w[2];
  J->data[131] = -udata->p[3];
  J->data[132] = -udata->p[0]*tdata->w[0];
  J->data[133] = udata->p[0]*tdata->w[0];
  J->data[134] = udata->p[1]*x_tmp[1]*-4.0;
  J->data[135] = udata->p[1]*x_tmp[1]*2.0;
  J->data[136] = -udata->p[2];
  J->data[137] = udata->k[0]*udata->p[2]*tdata->w[3];
  ...
  J->data[148] = udata->k[1]*udata->p[3]*tdata->w[2];
  J->data[149] = -udata->p[3];
  J->data[150] = -udata->p[0]*tdata->w[0];
  J->data[151] = udata->p[0]*tdata->w[0];
  J->data[152] = udata->p[1]*x_tmp[1]*-4.0;
  J->data[153] = udata->p[1]*x_tmp[1]*2.0;
  J->data[154] = -udata->p[2];
  J->data[155] = udata->k[0]*udata->p[2]*tdata->w[3];
  ...
  J->data[166] = udata->k[1]*udata->p[3]*tdata->w[2];
  J->data[167] = -udata->p[3];
  J->data[168] = -udata->p[0]*tdata->w[0];
  J->data[169] = udata->p[0]*tdata->w[0];
  J->data[170] = udata->p[1]*x_tmp[1]*-4.0;
  J->data[171] = udata->p[1]*x_tmp[1]*2.0;
  J->data[172] = -udata->p[2];
  J->data[173] = udata->k[0]*udata->p[2]*tdata->w[3];
  ...
  J->data[184] = udata->k[1]*udata->p[3]*tdata->w[2];
  J->data[185] = -udata->p[3];
  J->data[186] = -udata->p[0]*tdata->w[0];
  J->data[187] = udata->p[0]*tdata->w[0];
  J->data[188] = udata->p[1]*x_tmp[1]*-4.0;
  J->data[189] = udata->p[1]*x_tmp[1]*2.0;
  J->data[190] = -udata->p[2];
  J->data[191] = udata->k[0]*udata->p[2]*tdata->w[3];
  ...
  J->data[202] = udata->k[1]*udata->p[3]*tdata->w[2];
  J->data[203] = -udata->p[3];
  J->data[204] = -udata->p[0]*tdata->w[0];
  J->data[205] = udata->p[0]*tdata->w[0];
  J->data[206] = udata->p[1]*x_tmp[1]*-4.0;
  J->data[207] = udata->p[1]*x_tmp[1]*2.0;
  J->data[208] = -udata->p[2];
  J->data[209] = udata->k[0]*udata->p[2]*tdata->w[3];
  ...
  J->data[220] = udata->k[1]*udata->p[3]*tdata->w[2];
  J->data[221] = -udata->p[3];
  J->data[222] = -udata->p[0]*tdata->w[0];
  J->data[223] = udata->p[0]*tdata->w[0];
  J->data[224] = udata->p[1]*x_tmp[1]*-4.0;
  J->data[225] = udata->p[1]*x_tmp[1]*2.0;
  J->data[226] = -udata->p[2];
  J->data[227] = udata->k[0]*udata->p[2]*tdata->w[3];
  ...
  J->data[238] = udata->k[1]*udata->p[3]*tdata->w[2];
  J->data[239] = -udata->p[3];
  J->data[240] = -udata->p[0]*tdata->w[0];
  J->data[241] = udata->p[0]*tdata->w[0];
  J->data[242] = udata->p[1]*x_tmp[1]*-4.0;
  J->data[243] = udata->p[1]*x_tmp[1]*2.0;
  J->data[244] = -udata->p[2];
  J->data[245] = udata->k[0]*udata->p[2]*tdata->w[3];
  ...
  J->data[256] = udata->k[1]*udata->p[3]*tdata->w[2];
  J->data[257] = -udata->p[3];
  J->data[258] = -udata->p[0]*tdata->w[0];
  J->data[259] = udata->p[0]*tdata->w[0];
  J->data[260] = udata->p[1]*x_tmp[1]*-4.0;
  J->data[261] = udata->p[1]*x_tmp[1]*2.0;
  J->data[262] = -udata->p[2];
  J->data[263] = udata->k[0]*udata->p[2]*tdata->w[3];
  ...
  J->data[274] = udata->k[1]*udata->p[3]*tdata->w[2];
  J->data[275] = -udata->p[3];
  J->data[276] = -udata->p[0]*tdata->w[0];
  J->data[277] = udata->p[0]*tdata->w[0];
  J->data[278] = udata->p[1]*x_tmp[1]*-4.0;
  J->data[279] = udata->p[1]*x_tmp[1]*2.0;
  J->data[280] = -udata->p[2];
  J->data[281] = udata->k[0]*udata->p[2]*tdata->w[3];
  ...
  J->data[292] = udata->k[1]*udata->p[3]*tdata->w[2];
  J->data[293] = -udata->p[3];
  J->data[294] = -udata->p[0]*tdata->w[0];
  J->data[295] = udata->p[0]*tdata->w[0];
  J->data[296] = udata->p[1]*x_tmp[1]*-4.0;
  J->data[297] = udata->p[1]*x_tmp[1]*2.0;
  J->data[298] = -udata->p[2];
  J->data[299] = udata->k[0]*udata->p[2]*tdata->w[3];
  ...
  J->data[310] = udata->k[1]*udata->p[3]*tdata->w[2];
  J->data[311] = -udata->p[3];
  J->data[312] = -udata->p[0]*tdata->w[0];
  J->data[313] = udata->p[0]*tdata->w[0];
  J->data[314] = udata->p[1]*x_tmp[1]*-4.0;
  J->data[315] = udata->p[1]*x_tmp[1]*2.0;
  J->data[316] = -udata->p[2];
  J->data[317] = udata->k[0]*udata->p[2]*tdata->w[3];
  ...
  J->data[328] = udata->k[1]*udata->p[3]*tdata->w[2];
  J->data[329] = -udata->p[3];
  J->data[330] = -udata->p[0]*tdata->w[0];
  J->data[331] = udata->p[0]*tdata->w[0];
  J->data[332] = udata->p[1]*x_tmp[1]*-4.0;
  J->data[333] = udata->p[1]*x_tmp[1]*2.0;
  J->data[334] = -udata->p[2];
  J->data[335] = udata->k[0]*udata->p[2]*tdata->w[3];
  ...
  J->data[346] = udata->k[1]*udata->p[3]*tdata->w[2];
  J->data[347] = -udata->p[3];
  J->data[348] = -udata->p[0]*tdata->w[0];
  J->data[349] = udata->p[0]*tdata->w[0];
  J->data[350] = udata->p[1]*x_tmp[1]*-4.0;
  J->data[351] = udata->p[1]*x_tmp[1]*2.0;
  J->data[352] = -udata->p[2];
  J->data[353] = udata->k[0]*udata->p[2]*tdata->w[3];
  ...
  J->data[364] = udata->k[1]*udata->p[3]*tdata->w[2];
  J->data[365] = -udata->p[3];
  J->data[366] = -udata->p[0]*tdata->w[0];
  J->data[367] = udata->p[0]*tdata->w[0];
  J->data[368] = udata->p[1]*x_tmp[1]*-4.0;
  J->data[369] = udata->p[1]*x_tmp[1]*2.0;
  J->data[370] = -udata->p[2];
  J->data[371] = udata->k[0]*udata->p[2]*tdata->w[3];
  ...
  J->data[382] = udata->k[1]*udata->p[3]*tdata->w[2];
