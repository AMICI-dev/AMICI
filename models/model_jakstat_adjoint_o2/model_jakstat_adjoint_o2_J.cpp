...
status = dwdx_model_jakstat_adjoint_o2(t,x,NULL,user_data);
  J->data[0+0*162] = -udata->k[0]*udata->p[0]*tdata->w[0]*tdata->w[2];
  J->data[0+8*162] = udata->k[1]*udata->p[3]*tdata->w[2];
  J->data[1+0*162] = udata->p[0]*tdata->w[0];
  J->data[1+1*162] = udata->p[1]*tdata->dwdx[0]*-2.0;
  J->data[2+1*162] = udata->p[1]*tdata->dwdx[0];
  J->data[2+2*162] = -udata->p[2];
  J->data[3+2*162] = udata->k[0]*udata->p[2]*tdata->w[3];
  J->data[3+3*162] = -udata->k[1]*udata->p[3]*tdata->w[3];
  J->data[4+3*162] = udata->p[3]*tdata->dwdx[1];
  ...
  J->data[9+9*162] = -udata->p[0]*tdata->w[0];
  J->data[9+17*162] = udata->k[1]*udata->p[3]*tdata->w[2];
  J->data[10+0*162] = tdata->w[0];
  J->data[10+1*162] = udata->p[1]*x_tmp[10]*-4.0;
  J->data[10+9*162] = udata->p[0]*tdata->w[0];
  ...
  J->data[12+11*162] = udata->k[0]*udata->p[2]*tdata->w[3];
  ...
  J->data[18+18*162] = -udata->p[0]*tdata->w[0];
  J->data[18+26*162] = udata->k[1]*udata->p[3]*tdata->w[2];
  J->data[19+1*162] = tdata->dwdx[0]*-2.0-udata->p[1]*x_tmp[19]*4.0;
  J->data[19+18*162] = udata->p[0]*tdata->w[0];
  J->data[19+19*162] = udata->p[1]*x_tmp[1]*-4.0;
  J->data[20+1*162] = tdata->dwdx[0]+udata->p[1]*x_tmp[19]*2.0;
  J->data[20+19*162] = udata->p[1]*x_tmp[1]*2.0;
  J->data[20+20*162] = -udata->p[2];
  J->data[21+20*162] = udata->k[0]*udata->p[2]*tdata->w[3];
  ...
  J->data[27+27*162] = -udata->p[0]*tdata->w[0];
  J->data[27+35*162] = udata->k[1]*udata->p[3]*tdata->w[2];
  J->data[28+1*162] = udata->p[1]*x_tmp[28]*-4.0;
  J->data[28+27*162] = udata->p[0]*tdata->w[0];
  ...
  J->data[30+29*162] = udata->k[0]*udata->p[2]*tdata->w[3];
  ...
  J->data[36+36*162] = -udata->p[0]*tdata->w[0];
  J->data[36+44*162] = udata->k[1]*udata->p[3]*tdata->w[2];
  J->data[37+1*162] = udata->p[1]*x_tmp[37]*-4.0;
  J->data[37+36*162] = udata->p[0]*tdata->w[0];
  ...
  J->data[39+3*162] = -1.0;
  J->data[39+38*162] = udata->k[0]*udata->p[2]*tdata->w[3];
  ...
  J->data[45+45*162] = -udata->p[0]*tdata->w[0];
  J->data[45+53*162] = udata->k[1]*udata->p[3]*tdata->w[2];
  J->data[46+1*162] = udata->p[1]*x_tmp[46]*-4.0;
  J->data[46+45*162] = udata->p[0]*tdata->w[0];
  ...
  J->data[48+47*162] = udata->k[0]*udata->p[2]*tdata->w[3];
  ...
  J->data[54+0*162] = -udata->p[0]*tdata->w[5];
  J->data[54+54*162] = -udata->p[0]*tdata->w[0];
  J->data[54+62*162] = udata->k[1]*udata->p[3]*tdata->w[2];
  J->data[55+0*162] = udata->p[0]*tdata->w[5];
  J->data[55+1*162] = udata->p[1]*x_tmp[55]*-4.0;
  J->data[55+54*162] = udata->p[0]*tdata->w[0];
  ...
  J->data[57+56*162] = udata->k[0]*udata->p[2]*tdata->w[3];
  ...
  J->data[63+0*162] = -udata->p[0]*tdata->w[6];
  J->data[63+63*162] = -udata->p[0]*tdata->w[0];
  J->data[63+71*162] = udata->k[1]*udata->p[3]*tdata->w[2];
  J->data[64+0*162] = udata->p[0]*tdata->w[6];
  J->data[64+1*162] = udata->p[1]*x_tmp[64]*-4.0;
  J->data[64+63*162] = udata->p[0]*tdata->w[0];
  ...
  J->data[66+65*162] = udata->k[0]*udata->p[2]*tdata->w[3];
  ...
  J->data[72+0*162] = -udata->p[0]*tdata->w[7];
  J->data[72+72*162] = -udata->p[0]*tdata->w[0];
  J->data[72+80*162] = udata->k[1]*udata->p[3]*tdata->w[2];
  J->data[73+0*162] = udata->p[0]*tdata->w[7];
  J->data[73+1*162] = udata->p[1]*x_tmp[73]*-4.0;
  J->data[73+72*162] = udata->p[0]*tdata->w[0];
  ...
  J->data[75+74*162] = udata->k[0]*udata->p[2]*tdata->w[3];
  ...
  J->data[81+0*162] = -udata->p[0]*tdata->w[8];
  J->data[81+81*162] = -udata->p[0]*tdata->w[0];
  J->data[81+89*162] = udata->k[1]*udata->p[3]*tdata->w[2];
  J->data[82+0*162] = udata->p[0]*tdata->w[8];
  J->data[82+1*162] = udata->p[1]*x_tmp[82]*-4.0;
  J->data[82+81*162] = udata->p[0]*tdata->w[0];
  ...
  J->data[84+83*162] = udata->k[0]*udata->p[2]*tdata->w[3];
  ...
  J->data[90+0*162] = -udata->p[0]*tdata->w[9];
  J->data[90+90*162] = -udata->p[0]*tdata->w[0];
  J->data[90+98*162] = udata->k[1]*udata->p[3]*tdata->w[2];
  J->data[91+0*162] = udata->p[0]*tdata->w[9];
  J->data[91+1*162] = udata->p[1]*x_tmp[91]*-4.0;
  J->data[91+90*162] = udata->p[0]*tdata->w[0];
  ...
  J->data[93+92*162] = udata->k[0]*udata->p[2]*tdata->w[3];
  ...
  J->data[99+99*162] = -udata->p[0]*tdata->w[0];
  J->data[99+107*162] = udata->k[1]*udata->p[3]*tdata->w[2];
  J->data[100+1*162] = udata->p[1]*x_tmp[100]*-4.0;
  J->data[100+99*162] = udata->p[0]*tdata->w[0];
  ...
  J->data[102+101*162] = udata->k[0]*udata->p[2]*tdata->w[3];
  ...
  J->data[108+108*162] = -udata->p[0]*tdata->w[0];
  J->data[108+116*162] = udata->k[1]*udata->p[3]*tdata->w[2];
  J->data[109+1*162] = udata->p[1]*x_tmp[109]*-4.0;
  J->data[109+108*162] = udata->p[0]*tdata->w[0];
  ...
  J->data[111+110*162] = udata->k[0]*udata->p[2]*tdata->w[3];
  ...
  J->data[117+117*162] = -udata->p[0]*tdata->w[0];
  J->data[117+125*162] = udata->k[1]*udata->p[3]*tdata->w[2];
  J->data[118+1*162] = udata->p[1]*x_tmp[118]*-4.0;
  J->data[118+117*162] = udata->p[0]*tdata->w[0];
  ...
  J->data[120+119*162] = udata->k[0]*udata->p[2]*tdata->w[3];
  ...
  J->data[126+126*162] = -udata->p[0]*tdata->w[0];
  J->data[126+134*162] = udata->k[1]*udata->p[3]*tdata->w[2];
  J->data[127+1*162] = udata->p[1]*x_tmp[127]*-4.0;
  J->data[127+126*162] = udata->p[0]*tdata->w[0];
  ...
  J->data[129+128*162] = udata->k[0]*udata->p[2]*tdata->w[3];
  ...
  J->data[135+135*162] = -udata->p[0]*tdata->w[0];
  J->data[135+143*162] = udata->k[1]*udata->p[3]*tdata->w[2];
  J->data[136+1*162] = udata->p[1]*x_tmp[136]*-4.0;
  J->data[136+135*162] = udata->p[0]*tdata->w[0];
  ...
  J->data[138+137*162] = udata->k[0]*udata->p[2]*tdata->w[3];
  ...
  J->data[144+144*162] = -udata->p[0]*tdata->w[0];
  J->data[144+152*162] = udata->k[1]*udata->p[3]*tdata->w[2];
  J->data[145+1*162] = udata->p[1]*x_tmp[145]*-4.0;
  J->data[145+144*162] = udata->p[0]*tdata->w[0];
  ...
  J->data[147+146*162] = udata->k[0]*udata->p[2]*tdata->w[3];
  ...
  J->data[153+153*162] = -udata->p[0]*tdata->w[0];
  J->data[153+161*162] = udata->k[1]*udata->p[3]*tdata->w[2];
  J->data[154+1*162] = udata->p[1]*x_tmp[154]*-4.0;
  J->data[154+153*162] = udata->p[0]*tdata->w[0];
  ...
  J->data[156+155*162] = udata->k[0]*udata->p[2]*tdata->w[3];
