...
status = dwdx_model_jakstat_adjoint_o2(t,x,NULL,user_data);
  ...
  xBdot_tmp[3] = -tdata->p[3]*xB_tmp[4]*tdata->dwdx[1]+udata->k[1]*tdata->p[3]*tdata->w[3]*xB_tmp[3];
  ...
  xBdot_tmp[8] = tdata->p[3]*xB_tmp[8]-udata->k[1]*tdata->p[3]*tdata->w[2]*xB_tmp[0];
  xBdot_tmp[9] = tdata->w[0]*xB_tmp[0]-tdata->w[0]*xB_tmp[1]+tdata->p[0]*tdata->w[0]*xB_tmp[9]-tdata->p[0]*tdata->w[0]*xB_tmp[10];
  xBdot_tmp[10] = tdata->p[1]*x_tmp[1]*xB_tmp[10]*4.0+tdata->p[1]*x_tmp[10]*xB_tmp[1]*4.0-tdata->p[1]*x_tmp[1]*xB_tmp[11]*2.0-tdata->p[1]*x_tmp[10]*xB_tmp[2]*2.0;
  ...
  xBdot_tmp[19] = xB_tmp[1]*(tdata->dwdx[0]*2.0+tdata->p[1]*x_tmp[19]*4.0)-xB_tmp[2]*(tdata->dwdx[0]+tdata->p[1]*x_tmp[19]*2.0)+tdata->p[1]*x_tmp[1]*xB_tmp[19]*4.0-tdata->p[1]*x_tmp[1]*xB_tmp[20]*2.0;
  ...
  xBdot_tmp[28] = tdata->p[1]*x_tmp[1]*xB_tmp[28]*4.0+tdata->p[1]*x_tmp[28]*xB_tmp[1]*4.0-tdata->p[1]*x_tmp[1]*xB_tmp[29]*2.0-tdata->p[1]*x_tmp[28]*xB_tmp[2]*2.0;
  xBdot_tmp[29] = xB_tmp[2]+tdata->p[2]*xB_tmp[29]-udata->k[0]*tdata->w[3]*xB_tmp[3]-udata->k[0]*tdata->p[2]*tdata->w[3]*xB_tmp[30];
  ...
  xBdot_tmp[37] = tdata->p[1]*x_tmp[1]*xB_tmp[37]*4.0+tdata->p[1]*x_tmp[37]*xB_tmp[1]*4.0-tdata->p[1]*x_tmp[1]*xB_tmp[38]*2.0-tdata->p[1]*x_tmp[37]*xB_tmp[2]*2.0;
  xBdot_tmp[38] = tdata->p[2]*xB_tmp[38]-udata->k[0]*tdata->p[2]*tdata->w[3]*xB_tmp[39];
  xBdot_tmp[39] = xB_tmp[3]+tdata->p[3]*xB_tmp[39]-tdata->p[3]*xB_tmp[40]*2.0-xB_tmp[4]*tdata->dwdx[1];
  xBdot_tmp[40] = xB_tmp[4]-xB_tmp[5]+tdata->p[3]*xB_tmp[40]-tdata->p[3]*xB_tmp[41];
  xBdot_tmp[41] = xB_tmp[5]-xB_tmp[6]+tdata->p[3]*xB_tmp[41]-tdata->p[3]*xB_tmp[42];
  xBdot_tmp[42] = xB_tmp[6]-xB_tmp[7]+tdata->p[3]*xB_tmp[42]-tdata->p[3]*xB_tmp[43];
  xBdot_tmp[43] = xB_tmp[7]-xB_tmp[8]+tdata->p[3]*xB_tmp[43]-tdata->p[3]*xB_tmp[44];
  xBdot_tmp[44] = xB_tmp[8]+tdata->p[3]*xB_tmp[44]-udata->k[1]*tdata->w[2]*xB_tmp[0]-udata->k[1]*tdata->p[3]*tdata->w[2]*xB_tmp[36];
  xBdot_tmp[45] = tdata->p[0]*tdata->w[0]*xB_tmp[45]-tdata->p[0]*tdata->w[0]*xB_tmp[46];
  xBdot_tmp[46] = tdata->p[1]*x_tmp[1]*xB_tmp[46]*4.0+tdata->p[1]*x_tmp[46]*xB_tmp[1]*4.0-tdata->p[1]*x_tmp[1]*xB_tmp[47]*2.0-tdata->p[1]*x_tmp[46]*xB_tmp[2]*2.0;
  ...
  xBdot_tmp[54] = tdata->p[0]*tdata->w[5]*xB_tmp[0]-tdata->p[0]*tdata->w[5]*xB_tmp[1]+tdata->p[0]*tdata->w[0]*xB_tmp[54]-tdata->p[0]*tdata->w[0]*xB_tmp[55];
  xBdot_tmp[55] = tdata->p[1]*x_tmp[1]*xB_tmp[55]*4.0+tdata->p[1]*x_tmp[55]*xB_tmp[1]*4.0-tdata->p[1]*x_tmp[1]*xB_tmp[56]*2.0-tdata->p[1]*x_tmp[55]*xB_tmp[2]*2.0;
  ...
  xBdot_tmp[63] = tdata->p[0]*tdata->w[6]*xB_tmp[0]-tdata->p[0]*tdata->w[6]*xB_tmp[1]+tdata->p[0]*tdata->w[0]*xB_tmp[63]-tdata->p[0]*tdata->w[0]*xB_tmp[64];
  xBdot_tmp[64] = tdata->p[1]*x_tmp[1]*xB_tmp[64]*4.0+tdata->p[1]*x_tmp[64]*xB_tmp[1]*4.0-tdata->p[1]*x_tmp[1]*xB_tmp[65]*2.0-tdata->p[1]*x_tmp[64]*xB_tmp[2]*2.0;
  ...
  xBdot_tmp[72] = tdata->p[0]*tdata->w[7]*xB_tmp[0]-tdata->p[0]*tdata->w[7]*xB_tmp[1]+tdata->p[0]*tdata->w[0]*xB_tmp[72]-tdata->p[0]*tdata->w[0]*xB_tmp[73];
  xBdot_tmp[73] = tdata->p[1]*x_tmp[1]*xB_tmp[73]*4.0+tdata->p[1]*xB_tmp[1]*x_tmp[73]*4.0-tdata->p[1]*x_tmp[1]*xB_tmp[74]*2.0-tdata->p[1]*xB_tmp[2]*x_tmp[73]*2.0;
  ...
  xBdot_tmp[81] = tdata->p[0]*tdata->w[8]*xB_tmp[0]-tdata->p[0]*tdata->w[8]*xB_tmp[1]+tdata->p[0]*tdata->w[0]*xB_tmp[81]-tdata->p[0]*tdata->w[0]*xB_tmp[82];
  xBdot_tmp[82] = tdata->p[1]*x_tmp[1]*xB_tmp[82]*4.0+tdata->p[1]*xB_tmp[1]*x_tmp[82]*4.0-tdata->p[1]*x_tmp[1]*xB_tmp[83]*2.0-tdata->p[1]*xB_tmp[2]*x_tmp[82]*2.0;
  ...
  xBdot_tmp[90] = tdata->p[0]*tdata->w[9]*xB_tmp[0]-tdata->p[0]*tdata->w[9]*xB_tmp[1]+tdata->p[0]*tdata->w[0]*xB_tmp[90]-tdata->p[0]*tdata->w[0]*xB_tmp[91];
  xBdot_tmp[91] = tdata->p[1]*x_tmp[1]*xB_tmp[91]*4.0+tdata->p[1]*xB_tmp[1]*x_tmp[91]*4.0-tdata->p[1]*x_tmp[1]*xB_tmp[92]*2.0-tdata->p[1]*xB_tmp[2]*x_tmp[91]*2.0;
  ...
  xBdot_tmp[100] = tdata->p[1]*x_tmp[1]*xB_tmp[100]*4.0+tdata->p[1]*xB_tmp[1]*x_tmp[100]*4.0-tdata->p[1]*x_tmp[1]*xB_tmp[101]*2.0-tdata->p[1]*xB_tmp[2]*x_tmp[100]*2.0;
  ...
  xBdot_tmp[109] = tdata->p[1]*x_tmp[1]*xB_tmp[109]*4.0+tdata->p[1]*xB_tmp[1]*x_tmp[109]*4.0-tdata->p[1]*x_tmp[1]*xB_tmp[110]*2.0-tdata->p[1]*xB_tmp[2]*x_tmp[109]*2.0;
  ...
  xBdot_tmp[118] = tdata->p[1]*x_tmp[1]*xB_tmp[118]*4.0+tdata->p[1]*xB_tmp[1]*x_tmp[118]*4.0-tdata->p[1]*x_tmp[1]*xB_tmp[119]*2.0-tdata->p[1]*xB_tmp[2]*x_tmp[118]*2.0;
  ...
  xBdot_tmp[127] = tdata->p[1]*x_tmp[1]*xB_tmp[127]*4.0+tdata->p[1]*xB_tmp[1]*x_tmp[127]*4.0-tdata->p[1]*x_tmp[1]*xB_tmp[128]*2.0-tdata->p[1]*xB_tmp[2]*x_tmp[127]*2.0;
  ...
  xBdot_tmp[136] = tdata->p[1]*x_tmp[1]*xB_tmp[136]*4.0+tdata->p[1]*xB_tmp[1]*x_tmp[136]*4.0-tdata->p[1]*x_tmp[1]*xB_tmp[137]*2.0-tdata->p[1]*xB_tmp[2]*x_tmp[136]*2.0;
  ...
  xBdot_tmp[145] = tdata->p[1]*x_tmp[1]*xB_tmp[145]*4.0+tdata->p[1]*xB_tmp[1]*x_tmp[145]*4.0-tdata->p[1]*x_tmp[1]*xB_tmp[146]*2.0-tdata->p[1]*xB_tmp[2]*x_tmp[145]*2.0;
  ...
  xBdot_tmp[154] = tdata->p[1]*x_tmp[1]*xB_tmp[154]*4.0+tdata->p[1]*xB_tmp[1]*x_tmp[154]*4.0-tdata->p[1]*x_tmp[1]*xB_tmp[155]*2.0-tdata->p[1]*xB_tmp[2]*x_tmp[154]*2.0;
