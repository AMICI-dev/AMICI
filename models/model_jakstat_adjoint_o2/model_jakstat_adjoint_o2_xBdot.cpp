...
status = dwdx_model_jakstat_adjoint_o2(t,x,NULL,user_data);
  xBdot_tmp[0] = -udata->p[0]*udata->w[0]*xB_tmp[1]+udata->k[0]*udata->p[0]*udata->w[0]*udata->w[2]*xB_tmp[0];
  xBdot_tmp[1] = udata->p[1]*xB_tmp[1]*udata->dwdx[0]*2.0-udata->p[1]*xB_tmp[2]*udata->dwdx[0];
  xBdot_tmp[2] = udata->p[2]*xB_tmp[2]-udata->k[0]*udata->p[2]*udata->w[3]*xB_tmp[3];
  xBdot_tmp[3] = -udata->p[3]*xB_tmp[4]*udata->dwdx[1]+udata->k[1]*udata->p[3]*udata->w[3]*xB_tmp[3];
  ...
  xBdot_tmp[8] = udata->p[3]*xB_tmp[8]-udata->k[1]*udata->p[3]*udata->w[2]*xB_tmp[0];
  xBdot_tmp[9] = udata->w[0]*xB_tmp[0]-udata->w[0]*xB_tmp[1]+udata->p[0]*udata->w[0]*xB_tmp[9]-udata->p[0]*udata->w[0]*xB_tmp[10];
  ...
  xBdot_tmp[11] = udata->p[2]*xB_tmp[11]-udata->k[0]*udata->p[2]*udata->w[3]*xB_tmp[12];
  ...
  xBdot_tmp[17] = udata->p[3]*xB_tmp[17]-udata->k[1]*udata->p[3]*udata->w[2]*xB_tmp[9];
  xBdot_tmp[18] = udata->p[0]*udata->w[0]*xB_tmp[18]-udata->p[0]*udata->w[0]*xB_tmp[19];
  xBdot_tmp[19] = xB_tmp[1]*(udata->dwdx[0]*2.0+udata->p[1]*x_tmp[19]*4.0)-xB_tmp[2]*(udata->dwdx[0]+udata->p[1]*x_tmp[19]*2.0)+udata->p[1]*x_tmp[1]*xB_tmp[19]*4.0-udata->p[1]*x_tmp[1]*xB_tmp[20]*2.0;
  xBdot_tmp[20] = udata->p[2]*xB_tmp[20]-udata->k[0]*udata->p[2]*udata->w[3]*xB_tmp[21];
  ...
  xBdot_tmp[26] = udata->p[3]*xB_tmp[26]-udata->k[1]*udata->p[3]*udata->w[2]*xB_tmp[18];
  xBdot_tmp[27] = udata->p[0]*udata->w[0]*xB_tmp[27]-udata->p[0]*udata->w[0]*xB_tmp[28];
  ...
  xBdot_tmp[29] = xB_tmp[2]+udata->p[2]*xB_tmp[29]-udata->k[0]*udata->w[3]*xB_tmp[3]-udata->k[0]*udata->p[2]*udata->w[3]*xB_tmp[30];
  ...
  xBdot_tmp[35] = udata->p[3]*xB_tmp[35]-udata->k[1]*udata->p[3]*udata->w[2]*xB_tmp[27];
  xBdot_tmp[36] = udata->p[0]*udata->w[0]*xB_tmp[36]-udata->p[0]*udata->w[0]*xB_tmp[37];
  ...
  xBdot_tmp[38] = udata->p[2]*xB_tmp[38]-udata->k[0]*udata->p[2]*udata->w[3]*xB_tmp[39];
  xBdot_tmp[39] = xB_tmp[3]+udata->p[3]*xB_tmp[39]-udata->p[3]*xB_tmp[40]*2.0-xB_tmp[4]*udata->dwdx[1];
  ...
  xBdot_tmp[44] = xB_tmp[8]+udata->p[3]*xB_tmp[44]-udata->k[1]*udata->w[2]*xB_tmp[0]-udata->k[1]*udata->p[3]*udata->w[2]*xB_tmp[36];
  xBdot_tmp[45] = udata->p[0]*udata->w[0]*xB_tmp[45]-udata->p[0]*udata->w[0]*xB_tmp[46];
  ...
  xBdot_tmp[47] = udata->p[2]*xB_tmp[47]-udata->k[0]*udata->p[2]*udata->w[3]*xB_tmp[48];
  ...
  xBdot_tmp[53] = udata->p[3]*xB_tmp[53]-udata->k[1]*udata->p[3]*udata->w[2]*xB_tmp[45];
  xBdot_tmp[54] = udata->p[0]*udata->w[5]*xB_tmp[0]-udata->p[0]*udata->w[5]*xB_tmp[1]+udata->p[0]*udata->w[0]*xB_tmp[54]-udata->p[0]*udata->w[0]*xB_tmp[55];
  ...
  xBdot_tmp[56] = udata->p[2]*xB_tmp[56]-udata->k[0]*udata->p[2]*udata->w[3]*xB_tmp[57];
  ...
  xBdot_tmp[62] = udata->p[3]*xB_tmp[62]-udata->k[1]*udata->p[3]*udata->w[2]*xB_tmp[54];
  xBdot_tmp[63] = udata->p[0]*udata->w[6]*xB_tmp[0]-udata->p[0]*udata->w[6]*xB_tmp[1]+udata->p[0]*udata->w[0]*xB_tmp[63]-udata->p[0]*udata->w[0]*xB_tmp[64];
  ...
  xBdot_tmp[65] = udata->p[2]*xB_tmp[65]-udata->k[0]*udata->p[2]*udata->w[3]*xB_tmp[66];
  ...
  xBdot_tmp[71] = udata->p[3]*xB_tmp[71]-udata->k[1]*udata->p[3]*udata->w[2]*xB_tmp[63];
  xBdot_tmp[72] = udata->p[0]*udata->w[7]*xB_tmp[0]-udata->p[0]*udata->w[7]*xB_tmp[1]+udata->p[0]*udata->w[0]*xB_tmp[72]-udata->p[0]*udata->w[0]*xB_tmp[73];
  ...
  xBdot_tmp[74] = udata->p[2]*xB_tmp[74]-udata->k[0]*udata->p[2]*udata->w[3]*xB_tmp[75];
  ...
  xBdot_tmp[80] = udata->p[3]*xB_tmp[80]-udata->k[1]*udata->p[3]*udata->w[2]*xB_tmp[72];
  xBdot_tmp[81] = udata->p[0]*udata->w[8]*xB_tmp[0]-udata->p[0]*udata->w[8]*xB_tmp[1]+udata->p[0]*udata->w[0]*xB_tmp[81]-udata->p[0]*udata->w[0]*xB_tmp[82];
  ...
  xBdot_tmp[83] = udata->p[2]*xB_tmp[83]-udata->k[0]*udata->p[2]*udata->w[3]*xB_tmp[84];
  ...
  xBdot_tmp[89] = udata->p[3]*xB_tmp[89]-udata->k[1]*udata->p[3]*udata->w[2]*xB_tmp[81];
  xBdot_tmp[90] = udata->p[0]*udata->w[9]*xB_tmp[0]-udata->p[0]*udata->w[9]*xB_tmp[1]+udata->p[0]*udata->w[0]*xB_tmp[90]-udata->p[0]*udata->w[0]*xB_tmp[91];
  ...
  xBdot_tmp[92] = udata->p[2]*xB_tmp[92]-udata->k[0]*udata->p[2]*udata->w[3]*xB_tmp[93];
  ...
  xBdot_tmp[98] = udata->p[3]*xB_tmp[98]-udata->k[1]*udata->p[3]*udata->w[2]*xB_tmp[90];
  xBdot_tmp[99] = udata->p[0]*udata->w[0]*xB_tmp[99]-udata->p[0]*udata->w[0]*xB_tmp[100];
  ...
  xBdot_tmp[101] = udata->p[2]*xB_tmp[101]-udata->k[0]*udata->p[2]*udata->w[3]*xB_tmp[102];
  ...
  xBdot_tmp[107] = udata->p[3]*xB_tmp[107]-udata->k[1]*udata->p[3]*udata->w[2]*xB_tmp[99];
  xBdot_tmp[108] = udata->p[0]*udata->w[0]*xB_tmp[108]-udata->p[0]*udata->w[0]*xB_tmp[109];
  ...
  xBdot_tmp[110] = udata->p[2]*xB_tmp[110]-udata->k[0]*udata->p[2]*udata->w[3]*xB_tmp[111];
  ...
  xBdot_tmp[116] = udata->p[3]*xB_tmp[116]-udata->k[1]*udata->p[3]*udata->w[2]*xB_tmp[108];
  xBdot_tmp[117] = udata->p[0]*udata->w[0]*xB_tmp[117]-udata->p[0]*udata->w[0]*xB_tmp[118];
  ...
  xBdot_tmp[119] = udata->p[2]*xB_tmp[119]-udata->k[0]*udata->p[2]*udata->w[3]*xB_tmp[120];
  ...
  xBdot_tmp[125] = udata->p[3]*xB_tmp[125]-udata->k[1]*udata->p[3]*udata->w[2]*xB_tmp[117];
  xBdot_tmp[126] = udata->p[0]*udata->w[0]*xB_tmp[126]-udata->p[0]*udata->w[0]*xB_tmp[127];
  ...
  xBdot_tmp[128] = udata->p[2]*xB_tmp[128]-udata->k[0]*udata->p[2]*udata->w[3]*xB_tmp[129];
  ...
  xBdot_tmp[134] = udata->p[3]*xB_tmp[134]-udata->k[1]*udata->p[3]*udata->w[2]*xB_tmp[126];
  xBdot_tmp[135] = udata->p[0]*udata->w[0]*xB_tmp[135]-udata->p[0]*udata->w[0]*xB_tmp[136];
  ...
  xBdot_tmp[137] = udata->p[2]*xB_tmp[137]-udata->k[0]*udata->p[2]*udata->w[3]*xB_tmp[138];
  ...
  xBdot_tmp[143] = udata->p[3]*xB_tmp[143]-udata->k[1]*udata->p[3]*udata->w[2]*xB_tmp[135];
  xBdot_tmp[144] = udata->p[0]*udata->w[0]*xB_tmp[144]-udata->p[0]*udata->w[0]*xB_tmp[145];
  ...
  xBdot_tmp[146] = udata->p[2]*xB_tmp[146]-udata->k[0]*udata->p[2]*udata->w[3]*xB_tmp[147];
  ...
  xBdot_tmp[152] = udata->p[3]*xB_tmp[152]-udata->k[1]*udata->p[3]*udata->w[2]*xB_tmp[144];
  xBdot_tmp[153] = udata->p[0]*udata->w[0]*xB_tmp[153]-udata->p[0]*udata->w[0]*xB_tmp[154];
  ...
  xBdot_tmp[155] = udata->p[2]*xB_tmp[155]-udata->k[0]*udata->p[2]*udata->w[3]*xB_tmp[156];
  ...
  xBdot_tmp[161] = udata->p[3]*xB_tmp[161]-udata->k[1]*udata->p[3]*udata->w[2]*xB_tmp[153];
for(ix = 0; ix<162; ix++) {
