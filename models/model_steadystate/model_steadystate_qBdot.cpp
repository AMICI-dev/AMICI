...
void qBdot_model_steadystate(realtype t, N_Vector x, N_Vector dx, N_Vector xB, N_Vector dxB, N_Vector qBdot, void *user_data) {
...
dwdp_model_steadystate(t,x,NULL,user_data);
