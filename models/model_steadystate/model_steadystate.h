...
/* Generated by amiwrap (R2017b) 4653233281f00922dfe7d5802414385bd29dbdbc */
#include <cmath>
#include <memory>
...
public:
    ...
    const  std::string getAmiciCommit() const override { return "4653233281f00922dfe7d5802414385bd29dbdbc"; };
