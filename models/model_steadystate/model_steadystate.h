...
#include "model_steadystate_drootdp.h"
#include "model_steadystate_drootdx.h"
...
int drootdp_model_steadystate(realtype t, int ie, N_Vector x, void *user_data, TempData *tdata);
int drootdx_model_steadystate(realtype t, int ie, N_Vector x, void *user_data, TempData *tdata);
...
int sroot_model_steadystate(realtype t, int ie, N_Vector x, N_Vector *sx, void *user_data, TempData *tdata, ReturnData *rdata);
