...
extern void dJydsigmay_model_steadystate_py(realtype *dJydsigmay, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my);
...
class Model_model_steadystate_py : public amici::Model_ODE {
  public:
    ...
    Model_model_steadystate_py()
        : amici::Model_ODE(
              ...
              amici::SimulationParameters(
                  ...
                  std::vector<realtype>{1.0, 0.5, 0.40000000000000002, 2.0, 0.10000000000000001}        // free parameters
              ),
    ...
    void fdJydsigmay(realtype *dJydsigmay, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my) override {
        dJydsigmay_model_steadystate_py(dJydsigmay, iy, p, k, y, sigmay, my);
    }
