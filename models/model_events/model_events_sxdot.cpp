...
void sxdot_model_events(int Ns, realtype t, N_Vector x, N_Vector dx, N_Vector xdot,int ip,  N_Vector sx, N_Vector sdx, N_Vector sxdot, void *user_data, N_Vector tmp1, N_Vector tmp2, N_Vector tmp3) {
...
if(ip == 0) {
    JSparse_model_events(t,0.0,x,NULL,xdot,tdata->J,user_data,NULL,NULL,NULL);
    dxdotdp_model_events(t,x,NULL,user_data);
}
