...
void deltaxB_model_nested_events(realtype t, int ie, N_Vector x, N_Vector xB, N_Vector xdot, N_Vector xdot_old, amici::TempData *tdata) {
...
memset(tdata->deltaxB,0,sizeof(realtype)*1);
