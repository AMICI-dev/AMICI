...
void qBdot_model_nested_events(realtype t, N_Vector x, N_Vector dx, N_Vector xB, N_Vector dxB, N_Vector qBdot, void *user_data) {
...
dwdp_model_nested_events(t,x,NULL,user_data);
