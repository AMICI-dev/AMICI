...
if(ip == 0) {
  ...
  sxdot_tmp[0] = tdata->dxdotdp[0 + ip*udata->nx]+tdata->J->data[0]*sx_tmp[0]+tdata->J->data[2]*sx_tmp[1];
  sxdot_tmp[1] = tdata->dxdotdp[1 + ip*udata->nx]+tdata->J->data[1]*sx_tmp[0]+tdata->J->data[3]*sx_tmp[1];
return(status);
