...
int sroot_model_dirac(realtype t, int ie, realtype *sroot, N_Vector x, N_Vector *sx, void *user_data, void *temp_data);
...
int sz_tf_model_dirac(realtype t, int ie, realtype *sz, N_Vector x, N_Vector *sx, void *user_data, void *temp_data);
...
int z_model_dirac(realtype t, int ie, realtype *z, N_Vector x, void *user_data, void *temp_data);
