...
/* Generated by amiwrap (R2017b) 5193a397de39f5bd4b7d98718067dc71f02f916e */
#include <cmath>
#include <memory>
...
public:
    ...
    const  std::string getAmiciCommit() const override { return "5193a397de39f5bd4b7d98718067dc71f02f916e"; };
