...
#include "wrapfunctions.h"
    ...
    return UserData(4,
                ...
                int fsroot(realtype t, int ie, realtype *sroot, N_Vector x, N_Vector *sx, void *user_data, void *temp_data){
                    return sroot_model_dirac(t, ie, sroot, x, sx, user_data, temp_data);
                }
