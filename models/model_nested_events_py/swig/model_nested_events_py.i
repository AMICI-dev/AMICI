...
extension_path = Path(__file__).parent / f'_model_nested_events_py{ext_suffix}'
_model_nested_events_py = amici._module_from_path(
    'model_nested_events_py._model_nested_events_py' if __package__ or '.' in __name__
    else '_model_nested_events_py',
    extension_path,
)

def _get_import_time():
    return _model_nested_events_py._get_import_time()
...
%module(package="model_nested_events_py",moduleimport=MODULEIMPORT) model_nested_events_py
