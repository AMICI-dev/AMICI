    ...
    switch(ie) {
        case 0:
            switch(ip) {
                case 0:
                case 1:
                    deltasx[0] = stau0*xdot_old0 + stau0*(dvdt - xdot_old0) - sx0;
                    deltasx[1] = stau0*(dudt - xdot_old1);
                    break;
                case 2:
                    deltasx[0] = stau0*xdot_old0 + stau0*(dvdt - xdot_old0) - sx0 - 1;
                    deltasx[1] = stau0*(dudt - xdot_old1);
                    break;
                case 3:
                    deltasx[0] = stau0*xdot_old0 + stau0*(dvdt - xdot_old0) - sx0;
                    deltasx[1] = stau0*(dudt - xdot_old1) + 1;
                    break;
            }
            break;
    }
