...
status = w_model_neuron_o2(t,x,NULL,tdata);
  ...
  JvB_tmp[2] = -udata->p[1]*vB_tmp[1]-tdata->w[1]*vB_tmp[2]-udata->p[0]*udata->p[1]*vB_tmp[3]-x_tmp[2]*vB_tmp[0]*tdata->dwdx[1];
  JvB_tmp[3] = vB_tmp[1]+vB_tmp[2]+udata->p[0]*vB_tmp[3];
  JvB_tmp[4] = -udata->p[0]*vB_tmp[1]-tdata->w[1]*vB_tmp[4]-udata->p[0]*udata->p[1]*vB_tmp[5]-x_tmp[4]*vB_tmp[0]*tdata->dwdx[1];
  JvB_tmp[5] = vB_tmp[4]+udata->p[0]*vB_tmp[5];
  JvB_tmp[6] = -tdata->w[1]*vB_tmp[6]-udata->p[0]*udata->p[1]*vB_tmp[7]-x_tmp[6]*vB_tmp[0]*tdata->dwdx[1];
  JvB_tmp[7] = vB_tmp[6]+udata->p[0]*vB_tmp[7];
  JvB_tmp[8] = -tdata->w[1]*vB_tmp[8]-udata->p[0]*udata->p[1]*vB_tmp[9]-x_tmp[8]*vB_tmp[0]*tdata->dwdx[1];
