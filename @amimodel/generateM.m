function generateM(this, amimodelo2)
    ...
    if(o2flag)
        ...
        fprintf(fid,['        sz(:,iz,:) = sol.zS(:,(iz-1)*(length(theta(options_ami.sens_ind)+1))+1,:);\n']);
        fprintf(fid,['    end\n']);
        switch(o2flag)
            case 1
            ...
            case 2
            fprintf(fid,['    s2x = reshape(sol.xS(:,' num2str(nxtrue+1) ':end,:),length(tout),' num2str(nxtrue) ',length(theta(options_ami.sens_ind)),1));\n']);
            fprintf(fid,['    s2y = reshape(sol.yS(:,' num2str(nytrue+1) ':end,:),length(tout),' num2str(nytrue) ',length(theta(options_ami.sens_ind)),1));\n']);   
        end
        fprintf(fid,['    for iz = 1:' num2str(nztrue) '\n']);
        switch(o2flag)
            case 1
        ...
        switch(amimodelo2.param)
            case 'log'
                ...
                switch(o2flag)
                    ...
                    case 2
                        fprintf(fid,['    sol.s2x = bsxfun(@times,s2x,permute(theta(options_ami.sens_ind),[3,2,1])) + bsxfun(@times,sx,permute(theta(options_ami.sens_ind),[3,2,1]));\n']);
                        fprintf(fid,['    sol.s2y = bsxfun(@times,s2y,permute(theta(options_ami.sens_ind),[3,2,1])) + bsxfun(@times,sy,permute(theta(options_ami.sens_ind),[3,2,1]));\n']);
            ...
            case 'log10'
                ...
                switch(o2flag)
                    ...
                    case 2
                        fprintf(fid,['    sol.s2x = bsxfun(@times,s2x,permute(theta(options_ami.sens_ind),[3,2,1])*log(10)) + bsxfun(@times,sx,permute(theta(options_ami.sens_ind),[3,2,1])*log(10)*log(10));\n']);
                        fprintf(fid,['    sol.s2y = bsxfun(@times,s2y,permute(theta(options_ami.sens_ind),[3,2,1])*log(10)) + bsxfun(@times,sy,permute(theta(options_ami.sens_ind),[3,2,1])*log(10)*log(10));\n']);
