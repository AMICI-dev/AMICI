...
if(this.adjoint_o2)
    funs = {funs{:},'xBdot','o2qBdot','JB','JvB','JBandB','JSparseB',...
        'dydx','dzdx','dzdp','drzdx','drzdp','deltaxB','o2deltaqB',...
        'dsigma_ydp','dsigma_zdp','sx0','dJydy','dJydsigma','dJzdz','dJzdsigma','dJrzdz','dJrzdsigma',...
        'dwdp','dxdotdp','dydp','dJdx','dJdp','ddxdotdpdp','s2x0',...
        'ddJydydy','ddydpdp','ddydpdx','ddydxdx','qBo2dot',...
        'ddJydsigmady','ddJydsigmadsigma','ddJy_s2sigma'};
end
