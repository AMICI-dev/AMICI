...
%     amiwrap('model_steadystate','model_steadystate_syms',exdir)
    ...
    amiData.Y = [0.8410,1.6662,0.3813;
        0.7089,1.0326,0.1127;
        0.6035,0.9752,0.0923];
    amiData.condition = [0.1,0.4,0.7,1];
    amiData.conditionPreequilibration = [0.1, 0.4, 0.7, 0.5];
    amiData.t = [0, 1, inf];
    amiData = amidata(amiData);

    amiOption = amioption();
    amiOption.sensi = 1;
    amiOption.sensi_meth = 1;
    amiOption.linsol = 9;
    amiOption.newton_preeq = true;
    amiOption.atol = 1e-12;
    amiOption.rtol = 1e-6;
    amiOption.newton_maxsteps = 10;
    amiOption.newton_maxlinsteps = 10;
    
    % load mex into memory
    sol = simulate_model_steadystate(amiData.t, ...
                                     log10(p), ...
                                     amiData.condition, ...
                                     amiData, ...
                                     amiOption);
