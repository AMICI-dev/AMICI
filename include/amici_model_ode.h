...
namespace amici {
    ...
    public:
         ...
         **/
        virtual int fJ(long int N, realtype t, N_Vector x, N_Vector xdot,
         ...
         * @param[in] user_data object with user input @type UserData
         **/
        virtual void fJDiag(realtype t, N_Vector JDiag, N_Vector x,
                            void *user_data) {
            UserData udata = (UserData) user_data;
            fdwdx(t,x,udata);
         ...
         * @return status flag indicating successful execution
         **/
        virtual int fJv(N_Vector v, N_Vector Jv, realtype t, N_Vector x, N_Vector xdot,
         ...
         * @return status flag indicating successful execution
         **/
        virtual int fJvB(N_Vector vB, N_Vector JvB, realtype t, N_Vector x, N_Vector xB, N_Vector xBdot,
         ...
         * @return status flag indicating successful execution
         */
        virtual int froot(realtype t, N_Vector x, realtype *root,
                          void *user_data) {
            UserData udata = (UserData) user_data;
         ...
         * @return status flag indicating successful execution
         */
        virtual int fxdot(realtype t, N_Vector x, N_Vector xdot, void *user_data) {
            UserData udata = (UserData) user_data;
            fw(t,x,udata);
         ...
         * @return status flag indicating successful execution
         */
        virtual int fxBdot(realtype t, N_Vector x, N_Vector xB,
