...
int cw_ge(double a, double b);
int Dcw_ge(int id, double a, double b);

/* gt */

int cw_gt(double a, double b);

int Dcw_gt(int id, double a, double b);

/* le */

int cw_le(double a, double b);
int Dcw_le(int id, double a, double b);

/* lt */

int cw_lt(double a, double b);

int Dcw_lt(int id, double a, double b);

/* If */

double cw_if(int condition, double truepart, double falsepart);
double Dcw_if(int id, int condition, double truepart, double falsepart);
...
int cw_and(int a, int b);
double Dcw_and(int id,int a, int b);

/* or */

int cw_or(int a, int b);
double Dcw_or(int id,int a, int b);
