...
class Model {
  public:
     ...
     */
    Model(const int np, const int nx, const int nxtrue, const int nk, const int ny, const int nytrue, const int nz,
          const int nztrue, const int ne, const int nJ, const int nw, const int ndwdx, const int ndwdp, const int nnz,
    ...
    /** Initial states
      * @param[out] x0 Vector to which the initial states will be written @type N_Vector
    ...
    /** Initial value for time derivative of states (only necessary for DAEs)
      ...
      * @param[out] dx0 Vector to which the initial derivative states will be written (only DAE) @type N_Vector
      * @param[in] user_data object with model specifications @type TempData
      * @return status flag indicating successful execution @type int
     **/
...
//    virtual int fdx0(const realtype *k, realtype *x) { return AMICI_ERROR_NOT_IMPLEMENTED; }
    ...
    /** Initial value for initial state sensitivities
      * @param[out] sx0 Vector to whith the initial state sensitivities @type N_Vector
      * @param[in] x Vector with the states @type N_Vector
      * @param[in] dx Vector with the derivative states (only DAE) @type N_Vector
      * @param[in] user_data object with model specifications @type TempData
      * @return status flag indicating successful execution @type int
     **/
    ...
    /** Sensitivity of derivative initial states sensitivities sdx0 (only necessary for DAEs)
      * @param[out] sdx0 Vector to whith the derivative initial state sensitivities @type N_Vector
      * @param[in] x Vector with the states @type N_Vector
      * @param[in] dx Vector with the derivative states (only DAE) @type N_Vector
      * @param[in] user_data object with model specifications @type TempData
      * @return status flag indicating successful execution @type int
    ...
    /** Jacobian of xdot with respect to states x
      ...
      * @param[in] cj scaling factor, inverse of the step size (only DAE) @type realtype
      * @param[in] x Vector with the states @type N_Vector
      * @param[in] dx Vector with the derivative states (only DAE) @type N_Vector
    ...
    /** diagonalized Jacobian (for preconditioning)
      * @param[in] t timepoint @type realtype
      * @param[out] JDiag Vector to which the Jacobian diagonal will be written @type NVector
      * @param[in] x Vector with the states @type N_Vector
      * @param[in] user_data object with model specifications @type TempData
      * @return status flag indicating successful execution @type int
     **/
    ...
    /** Matrix vector product of J with a vector v (for iterative solvers)
      ...
      * @param[out] Jv Vector to which the Jacobian vector product will be written @type N_Vector
      * @param[in] t timepoint @type realtype
      * @param[in] x Vector with the states @type N_Vector
      * @param[in] xdot Vector with the right hand side @type N_Vector
      * @param[in] user_data object with model specifications @type TempData
    ...
    /** Right hand side of differential equation for adjoint state xB
      ...
      * @param[in] dx Vector with the derivative states (only DAE) @type N_Vector
      * @param[in] xB Vector with the adjoint states @type N_Vector
      * @param[in] dxB Vector with the adjoint derivative states (only DAE) @type N_Vector
    ...
    /** Right hand side of integral equation for quadrature states qB
      ...
      * @param[in] x Vector with the states @type N_Vector
      * @param[in] xB Vector with the adjoint states @type N_Vector
      * @param[out] qBdot Vector with the adjoint quadrature right hand side @type N_Vector
      * @param[in] user_data pointer to temp data object @type TempData
      * @return status flag indicating successful execution @type int
      */
    ...
    /** State update functions for events
      ...
      * @param[in] xdot Vector with the right hand side @type N_Vector
      * @param[in] xdot_old Vector with the right hand side before the event @type N_Vector
      * @param[in] tdata pointer to temp data object @type TempData
      * @return status flag indicating successful execution @type int
      */
    ...
    /** Quadrature state update functions for events
      ...
      * @param[in] x Vector with the states @type N_Vector
      * @param[in] xB Vector with the adjoint states @type N_Vector
      * @param[in] qBdot Vector with the adjoint quadrature states @type N_Vector
      * @param[in] xdot Vector with the right hand side @type N_Vector
      * @param[in] xdot_old Vector with the right hand side before the event @type N_Vector
      * @param[in] tdata pointer to temp data object @type TempData
      * @return status flag indicating successful execution @type int
    ...
    /** Right hand side of differential equation for state sensitivities sx 
      ...
      * @param[in] sxdot Vector with the sensitivity right hand side @type N_Vector
      * @param[in] user_data pointer to temp data object @type TempData
      * @param[in] tmp1 temporary storage vector @type N_Vector
      * @param[in] tmp2 temporary storage vector @type N_Vector
      * @return status flag indicating successful execution @type int
    ...
    /** Matrix vector product of JB with a vector v (for iterative solvers)
      * @param[in] vB Vector with which the Jacobian is multiplied @type N_Vector
      * @param[out] JvB Vector to which the Jacobian vector product will be written @type N_Vector
      * @param[in] t timepoint @type realtype
      * @param[in] x Vector with the states @type N_Vector
      * @param[in] xB Vector with the adjoint states @type N_Vector
      * @param[in] xBdot Vector with the adjoint right hand side @type N_Vector
