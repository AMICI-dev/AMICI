...
int applyNewtonsMethod(void *ami_mem, UserData *udata, ReturnData *rdata, TempData *tdata, int ntry);
int getNewtonStep(void *ami_mem, UserData *udata, TempData *tdata)
