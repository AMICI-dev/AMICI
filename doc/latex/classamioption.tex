...
O\+P\+T\+S = amioption(O\+L\+D\+O\+P\+T\+S, P\+A\+R\+A\+M, V\+A\+L, ...) creates a copy of O\+L\+D\+O\+P\+T\+S with the named parameters altered with the specified value. O\+L\+D\+O\+P\+T\+S must not be of type amioption but can be a struct with the same fields

Note to see the parameters, check the documentation page for \hyperlink{classamioption}{amioption}


\begin{DoxyParams}{Parameters}
{\em varargin} & specification of non-\/default fields \\
\hline
\end{DoxyParams}


Definition at line 222 of file amioption.\+m.
...
Definition at line 185 of file amioption.\+m.
