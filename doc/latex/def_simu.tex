...
xdot(2) = [ +param2*x(1) + \hyperlink{symbolic__functions_8c_a9f096cac6ced6b3a2ec6c32f4f3651bd}{dirac}(t-param3) - const2*x(2) ];
xdot(3) = [ param4*x(2) ];
\end{DoxyCode}
...
f(2) = [ +param2*x(1) + \hyperlink{symbolic__functions_8c_a9f096cac6ced6b3a2ec6c32f4f3651bd}{dirac}(t-param3) - const2*x(2) ];
f(3) = [ 2*x(2) ];
\end{DoxyCode}
