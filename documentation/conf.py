...
if 'READTHEDOCS' not in os.environ:
    ...
    context = {
        ...
        'current_version': "fix_sphinx_path",
        'version_slug': "fix_sphinx_path",
        'MEDIA_URL': "https://media.readthedocs.org/",
        'STATIC_URL': "https://assets.readthedocs.org/static/",
        'PRODUCTION_DOMAIN': "readthedocs.org",
        'versions': [
            ("latest", "/en/latest/"),
            ("fix_sphinx_path", "/en/fix_sphinx_path/"),
            ("fix_rtd", "/en/fix_rtd/"),
            ("develop", "/en/develop/"),
        ],
        'downloads': [
        ...
        'canonical_url': 'https://amici.readthedocs.io/en/latest/',
        'analytics_code': 'None',
        ...
        'proxied_api_host': '/_',
        'github_repo': 'AMICI',
        'github_version': 'fix_sphinx_path',
        'display_github': True,
        'bitbucket_user': 'None',
        'bitbucket_repo': 'None',
        'bitbucket_version': 'fix_sphinx_path',
        'display_bitbucket': False,
        'gitlab_user': 'None',
        'gitlab_repo': 'None',
        'gitlab_version': 'fix_sphinx_path',
