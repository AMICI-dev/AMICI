% simulate_model_jakstat.m is the matlab interface to the cvodes mex
%   which simulates the ordinary differential equation and respective
%   sensitivities according to user specifications.
%
% USAGE:
% ======
% [...] = simulate_model_jakstat(tout,theta)
% [...] = simulate_model_jakstat(tout,theta,kappa,data,options)
% [status,tout,x,y,sx,sy] = simulate_model_jakstat(...)
%
% INPUTS:
% =======
...
function varargout = simulate_model_jakstat(varargin)
...
sol = ami_model_jakstat(tout,theta(1:17),kappa(1:2),options_ami,plist,pbar,xscale,data);
if(options_ami.sensi==1)
