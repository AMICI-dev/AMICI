% simulate_model_jakstat2_adjoint.m is the matlab interface to the cvodes mex
%   which simulates the ordinary differential equation and respective
%   sensitivities according to user specifications.
%
% USAGE:
% ======
% [...] = simulate_model_jakstat2_adjoint(tout,theta)
% [...] = simulate_model_jakstat2_adjoint(tout,theta,kappa,data,options)
% [status,tout,x,y,sx,sy] = simulate_model_jakstat2_adjoint(...)
%
% INPUTS:
% =======
...
function varargout = simulate_model_jakstat2_adjoint(varargin)
...
if(options_ami.sensi<2)
    sol = ami_model_jakstat2_adjoint(tout,theta(1:17),kappa(1:2),options_ami,plist,pbar,xscale,data);
else
    sol = ami_model_jakstat2_adjoint_o2vec(tout,theta(1:17),kappa(1:19),options_ami,plist,pbar,xscale,data);
end
if(options_ami.sensi==1)
