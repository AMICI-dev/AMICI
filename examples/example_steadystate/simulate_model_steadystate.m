% simulate_model_steadystate.m is the matlab interface to the cvodes mex
%   which simulates the ordinary differential equation and respective
%   sensitivities according to user specifications.
%
% USAGE:
% ======
% [...] = simulate_model_steadystate(tout,theta)
% [...] = simulate_model_steadystate(tout,theta,kappa,data,options)
% [status,tout,x,y,sx,sy] = simulate_model_steadystate(...)
%
% INPUTS:
% =======
...
function varargout = simulate_model_steadystate(varargin)
...
sol = ami_model_steadystate(tout,theta(1:5),kappa(1:4),options_ami,plist,pbar,xscale,data);
if(options_ami.sensi==1)
