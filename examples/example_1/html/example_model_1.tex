...
\end{verbatim}
        ...
        \color{lightgray} \begin{verbatim}Time elapsed with cvodes: 0.0023875
\end{verbatim} \color{black}
...
\end{verbatim}
        ...
        \color{lightgray} \begin{verbatim}Time elapsed with ode15s: 0.25847
\end{verbatim} \color{black}
...
\includegraphics [width=4in]{example_model_1_01.png}
...
\includegraphics [width=4in]{example_model_1_02.png}

\includegraphics [width=4in]{example_model_1_03.png}

\includegraphics [width=4in]{example_model_1_04.png}
