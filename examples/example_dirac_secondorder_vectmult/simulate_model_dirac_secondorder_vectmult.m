% simulate_model_dirac_secondorder_vectmult.m is the matlab interface to the cvodes mex
%   which simulates the ordinary differential equation and respective
%   sensitivities according to user specifications.
%
% USAGE:
% ======
% [...] = simulate_model_dirac_secondorder_vectmult(tout,theta)
% [...] = simulate_model_dirac_secondorder_vectmult(tout,theta,kappa,data,options)
% [status,tout,x,y,sx,sy] = simulate_model_dirac_secondorder_vectmult(...)
%
% INPUTS:
% =======
...
function varargout = simulate_model_dirac_secondorder_vectmult(varargin)
...
if(options_ami.sensi<2)
sol = ami_model_dirac_secondorder_vectmult(tout,theta(1:4),kappa(1:0),options_ami,plist,pbar,xscale,data);
else
