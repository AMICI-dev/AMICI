...
\end{verbatim}
        ...
        \color{lightgray} \begin{verbatim}Time elapsed with cvodes: 0.0038064
\end{verbatim} \color{black}
...
\end{verbatim}
        ...
        \color{lightgray} \begin{verbatim}Time elapsed with ode15s: 0.26754
\end{verbatim} \color{black}
...
\includegraphics [width=4in]{example_model_3_01.png}
...
\includegraphics [width=4in]{example_model_3_02.png}
...
\includegraphics [width=4in]{example_model_3_03.png}

\includegraphics [width=4in]{example_model_3_04.png}
