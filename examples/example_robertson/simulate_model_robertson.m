% simulate_model_robertson.m is the matlab interface to the cvodes mex
%   which simulates the ordinary differential equation and respective
%   sensitivities according to user specifications.
%   this routine was generated using AMICI commit 5ea68e9082f30323ef28ac9f664959f07dbbb243 in branch feature_exception_handling in repo https://github.com/ICB-DCM/AMICI.
%
% USAGE:
% ======
% [...] = simulate_model_robertson(tout,theta)
% [...] = simulate_model_robertson(tout,theta,kappa,data,options)
% [status,tout,x,y,sx,sy] = simulate_model_robertson(...)
%
% INPUTS:
% =======
...
function varargout = simulate_model_robertson(varargin)
...
sol = ami_model_robertson(tout,theta(1:3),kappa(1:1),options_ami,plist,pbar(plist+1),xscale,init,data);
if(nargout>1)
