...
void Model_DAE::fJB(realtype * /*JB*/, const realtype  /*t*/, const realtype * /*x*/, const double * /*p*/, const double * /*k*/, const realtype * /*h*/, const realtype  /*cj*/, const realtype * /*xB*/, const realtype * /*dx*/, const realtype * /*dxB*/, const realtype * /*w*/, const realtype * /*dwdx*/){
    throw AmiException("Requested functionality is not supported as %s is not implemented for this model!",__func__);
}

void Model_DAE::fJDiag(realtype * /*JDiag*/, const realtype  /*t*/, const realtype * /*x*/, const realtype * /*p*/, const realtype * /*k*/, const realtype * /*h*/, const realtype  /*cj*/, const realtype * /*dx*/, const realtype * /*w*/, const realtype * /*dwdx*/){
    throw AmiException("Requested functionality is not supported as %s is not implemented for this model!",__func__);
}

void Model_DAE::fJvB(realtype * /*JvB*/, const realtype t, const realtype *x, const double * /*p*/, const double * /*k*/, const realtype * /*h*/, const realtype  /*cj*/, const realtype * /*xB*/, const realtype * /*dx*/, const realtype * /*dxB*/, const realtype * /*vB*/, const realtype * /*w*/, const realtype * /*dwdx*/){
...
void Model_DAE::froot(realtype * /*root*/, const realtype  /*t*/, const realtype *x, const double *p, const double *k, const realtype * /*h*/, const realtype * /*dx*/){
    throw AmiException("Requested functionality is not supported as %s is not implemented for this model!",__func__); // not implemented
}

void Model_DAE::fdxdotdp(realtype * /*dxdotdp*/, const realtype  /*t*/, const realtype * /*x*/, const realtype * /*p*/, const realtype * /*k*/, const realtype * /*h*/, const int  /*ip*/, const realtype * /*dx*/, const realtype * /*w*/, const realtype * /*dwdp*/) {
    throw AmiException("Requested functionality is not supported as %s is not implemented for this model!",__func__);
}
