...
int ForwardProblem::workForwardProblem(UserData *udata, TempData *tdata,
                                       ...
                                       Model *model) {
    /**
         * workForwardProblem solves the forward problem. if forward
...
int ForwardProblem::handleEvent(realtype *tlastroot, UserData *udata,
     ...
     * @type *realtype
         * @param[in] udata pointer to the user data struct @type UserData
         * @param[out] rdata pointer to the return data struct @type ReturnData
         * @param[in] edata pointer to the experimental data struct @type
     * ExpData
         * @param[out] tdata pointer to the temporary data struct @type TempData
         * @param[in] seflag flag indicating whether this is a secondary event
     * @type int
...
int ForwardProblem::storeJacobianAndDerivativeInReturnData(TempData *tdata,
                                                           ...
                                                           Model *model) {
    /**
         * evalues the Jacobian and differential equation right hand side,
     * stores it in tdata and
...
int ForwardProblem::prepEventSensis(int ie, ReturnData *rdata,
                                    ...
                                    Model *model) {
    /**
         * prepEventSensis preprocesses the provided experimental data to
     * compute event sensitivities via adjoint or forward methods later on
         *
...
int ForwardProblem::handleDataPoint(int it, UserData *udata, ReturnData *rdata,
    ...
    /**
         * handleDataPoint executes everything necessary for the handling of
     * data points
         *
...
int ForwardProblem::updateHeaviside(TempData *tdata, int ne) {
    /**
         ...
         * @param[out] tdata pointer to the temporary data struct @type TempData
         * @return status = status flag indicating success of execution @type
     * int;
         */
