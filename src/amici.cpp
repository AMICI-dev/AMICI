 ...
 */
ReturnData *runAmiciSimulation(Solver &solver, const ExpData *edata, Model &model) {
    
    auto rdata = std::unique_ptr<ReturnData>(new ForwardProblem(rdata,edata,&model,&solver));
