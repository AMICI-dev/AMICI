...
namespace amici {
    ...
    void Model_DAE::fJ(realtype t, realtype cj, N_Vector x, N_Vector dx,
        ...
        fdwdx(t,x);
        SetToZero(J);
        fJ(J->data,t,N_VGetArrayPointer(x), unscaledParameters.data(),k_.data(),h.data(),
    ...
    void Model_DAE::fJSparse(realtype t, realtype cj, N_Vector x, N_Vector dx, SlsMat J) {
        ...
        fJSparse(J,t,N_VGetArrayPointer(x), unscaledParameters.data(),k_.data(),h.data(),
                        cj,N_VGetArrayPointer(dx),w.data(),dwdx.data());
    }
    ...
    void Model_DAE::fJv(realtype t, N_Vector x, N_Vector dx, N_Vector v, N_Vector Jv,
        ...
        fdwdx(t,x);
        N_VConst(0.0,Jv);
        fJv(N_VGetArrayPointer(Jv),t,N_VGetArrayPointer(x), unscaledParameters.data(),k_.data(),h.data(),
    ...
    void Model_DAE::froot(realtype t, N_Vector x, N_Vector dx, realtype *root) {
        ...
        froot(root,t,N_VGetArrayPointer(x), unscaledParameters.data(),k_.data(),h.data(),
    ...
    void Model_DAE::fxdot(realtype t, N_Vector x, N_Vector dx, N_Vector xdot) {
        fw(t,x);
        N_VConst(0.0,xdot);
        fxdot(N_VGetArrayPointer(xdot),t,N_VGetArrayPointer(x), unscaledParameters.data(),k_.data(),h.data(),
    ...
    void Model_DAE::fJDiag(realtype t, AmiVector *JDiag, realtype cj, AmiVector *x,
        ...
        fJDiag(JDiag->data(),t,x->data(), unscaledParameters.data(),k_.data(),h.data(),
     ...
     */
     void Model_DAE::fdxdotdp(const realtype t, const N_Vector x, const N_Vector dx) {
        ...
        for(int ip = 0; ip < nplist(); ip++)
            fdxdotdp(&dxdotdp.at(nx*ip),t,N_VGetArrayPointer(x), unscaledParameters.data(),k_.data(),h.data(),
     ...
     */
     void Model_DAE::fM(realtype t, const N_Vector x) {
        ...
        fM(M.data(),t,N_VGetArrayPointer(x), unscaledParameters.data(),k_.data());
    }
    ...
    void Model_DAE::fJB(realtype t, realtype cj, N_Vector x, N_Vector dx, N_Vector xB, N_Vector dxB, DlsMat JB) {
        fdwdx(t,x);
        SetToZero(JB);
        fJB(JB->data,t,N_VGetArrayPointer(x), unscaledParameters.data(),k_.data(),h.data(),
    ...
    void Model_DAE::fJSparseB(realtype t, realtype cj, N_Vector x, N_Vector dx, N_Vector xB, N_Vector dxB, SlsMat JB) {
        ...
        fJSparseB(JB,t,N_VGetArrayPointer(x), unscaledParameters.data(),k_.data(),h.data(),
                         cj,N_VGetArrayPointer(xB),N_VGetArrayPointer(dx),N_VGetArrayPointer(dxB),
                         w.data(),dwdx.data());
    }
    ...
    void Model_DAE::fJvB(realtype t, N_Vector x, N_Vector dx, N_Vector xB, N_Vector dxB,
        ...
        fdwdx(t,x);
        N_VConst(0.0,JvB);
        fJvB(N_VGetArrayPointer(JvB),t,N_VGetArrayPointer(x), unscaledParameters.data(),k_.data(),h.data(),
                    cj,N_VGetArrayPointer(xB),N_VGetArrayPointer(dx),N_VGetArrayPointer(dxB),
    ...
    void Model_DAE::fxBdot(realtype t, N_Vector x, N_Vector dx, N_Vector xB,
        ...
        fdwdx(t,x);
        N_VConst(0.0,xBdot);
        fxBdot(N_VGetArrayPointer(xBdot),t,N_VGetArrayPointer(x), unscaledParameters.data(),k_.data(),h.data(),
    ...
    void Model_DAE::fsxdot(realtype t, N_Vector x, N_Vector dx, int ip,
        ...
        N_VConst(0.0,sxdot);
        fsxdot(N_VGetArrayPointer(sxdot),t,N_VGetArrayPointer(x), unscaledParameters.data(),k_.data(),h.data(),
