...
$uri = 'https://github.com/xianyi/OpenBLAS/archive/v0.3.12.zip'
$output = 'C:\BLAS\v0.3.12.zip'
$webclient = New-Object System.Net.WebClient
$webclient.DownloadFile($uri,"$output")
Expand-Archive -Path 'C:\BLAS\v0.3.12.zip' -DestinationPath 'C:\BLAS\OpenBLAS-v0.3.12' -Force # expand zip file
C:\Users\travis\build\AMICI\scripts\compileBLAS.cmd
New-Item -Path 'C:\BLAS\lib' -ItemType Directory -Force # create directory
Copy-Item "C:\BLAS\OpenBLAS-v0.3.12\OpenBLAS-0.3.12\lib\Release\openblas.lib" -Destination "C:\BLAS\lib" -Recurse
New-Item -Path 'C:\BLAS\bin' -ItemType Directory -Force # create directory
Copy-Item "C:\BLAS\OpenBLAS-v0.3.12\OpenBLAS-0.3.12\lib\openblas.dll" -Destination "C:\BLAS\bin" -Recurse
